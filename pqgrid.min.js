...
h.strRefresh);this.rPPHolder.empty();if(h.strRpp){var k=h.rPPOptions,e=h.strRpp;if(-1!=e.indexOf("{0}")){for(var f=["<select class='ui-corner-all'>"],p=0,m=k.length;p<m;p++){var r=k[p];f.push('<option value="',r,'">',r,"</option>")}f.push("</select>");k=f.join("");e=e.replace("{0}","</span>"+k);e="<span>"+e+"<span class='pq-separator'></span>"}else e="<span>"+e+"</span><span class='pq-separator'></span>";this.$rPP=g(e).appendTo(this.rPPHolder).filter("select").val(h.rPP).change(function(a){var b=
...
a.offset().top+d?(window.clearInterval(c.mousedownInterval),c.mousedownInterval=null):c._pageDown(e)},0))}else{var q=e.pageX,m=c.element.offset().left,k=m+n.length,b=c.$slider.offset().left,l=b+c.$slider.width();q<b&&q>m+17?(c.$slider.css("left",q-c.element.offset().left),c._updateCurPosAndTrigger(e)):q>l&&q<k-17&&(c.$slider.css("left",q-c.element.offset().left-c.$slider.width()),c._updateCurPosAndTrigger(e))}});e=this.$slider=g("div.pq-sb-slider",this.element);k&&e.attr("tabindex","0");this._bindSliderEvents(e);
...
(function(g){var c=function(){};c.prototype.belongs=function(a){if(a.target==this.that.element[0])return!0};g.paramquery.cClass=c;var n=function(a){this.that=a;this.hidearrHS1=[];this.options=a.options;this.offset=null};g.paramquery.cGenerateView=n;c=n.prototype;c.generateView=function(a){var b=this.that,d=b.options,l=d.freezeCols,q=b.colModel,s,v,e=b.initH,c=b.finalH,f=d.groupModel,h=b.pqpanes;if(a){var f=this._generateTables(null,null,a),k=a.$cont;k.empty();h.v?k.append(["<div class='pq-cont-inner'>",
f,"</div><div class='pq-cont-inner'>",f,"</div>"].join("")):k.append("<div class='pq-cont-inner'>"+f+"</div>");var p=k.children("div"),f=p.children("table"),r=f[0].scrollHeight-1;k.height(r);if(h.v){var h=g(p[0]),k=f[0].scrollWidth,p=g(p[1]),n=g(f[1]),y=m.call(b,-1,l),l=m.call(b,l,e);h.css({width:y,zIndex:1});p.css({left:y-1,width:k,position:"absolute",height:r});n.css({left:-1*(l+y)})}b.tables||(b.tables=[]);l=-1;for(r=0;r<b.tables.length;r++)b.tables[r].cont==a.$cont[0]&&(l=r);-1==l?b.tables.push({$tbl:f,
cont:a.$cont[0]}):b.tables[l].$tbl=f}else{b._bufferObj_calcInitFinal();s=b.initV;v=b.finalV;var z=f?b.dataGM:b.pdata,k=b.$cont;null!=d.editModel.indices&&b.blurEditor({force:!0});f=this._generateTables(s,v,a);k.empty();0===b.totalVisibleRows?k.append("<div class='pq-cont-inner pq-grid-norows' >"+d.strNoRows+"</div>"):h.h&&h.v?k.append(["<div class='pq-cont-inner'>",f,"</div><div class='pq-cont-inner'>",f,"</div><div class='pq-cont-inner'>",f,"</div><div class='pq-cont-inner'>",f,"</div>"].join("")):
h.h||h.v?k.append(["<div class='pq-cont-inner'>",f,"</div><div class='pq-cont-inner'>",f,"</div>"].join("")):k.append("<div class='pq-cont-inner'>"+f+"</div>");b.$tbl=k.children("div").children("table");b._fixTableViewPort();b._trigger("afterTable",null,{dataModel:d.dataModel,colModel:q,pageData:z,initV:s,finalV:v,initH:e,finalH:c})}b._saveDims();this.scrollView();a||b._trigger("refresh",null,{dataModel:d.dataModel,colModel:q,pageData:z,initV:s,finalV:v,initH:e,finalH:c});b._saveDims();this.scrollView()};
c.scrollView=function(){var a=this.that,b=this.options,d=b.virtualY;b.virtualX||a.$hscroll.pqScrollBar("drag");d||a.$vscroll.pqScrollBar("drag")};c.setPanes=function(){var a=this.that,b=a.pqpanes,d=a.$cont.children("div"),l=a.$tbl,q=parseInt(a.options.freezeCols),s=a.initH;if(l&&l.length){var v=l[0].scrollWidth;if(b.h&&b.v){var s=g(d[0]),b=g(d[1]),e=g(l[1]),c=g(d[2]),f=g(l[2]),d=g(d[3]),h=g(l[3]),l=m.call(a,-1,q),a=a.calcHeightFrozenRows();s.css({width:l,height:a,zIndex:2});b.css({left:l,width:v,
height:a,position:"absolute"});e.css({left:-1*l});c.css({width:l,zIndex:1,top:a,position:"absolute"});f.css({top:-a});d.css({left:l,width:v,zIndex:1,top:a,position:"absolute"});h.css({top:-a,left:-1*l})}else b.v?(b=g(d[0]),d=g(d[1]),e=g(l[1]),l=m.call(a,-1,q),a=m.call(a,q,s),b.css({width:l,zIndex:1}),d.css({left:l,width:v,position:"absolute"}),e.css({left:-1*(a+l)})):b.h&&(q=g(d[0]),d=g(d[1]),l=g(l[1]),a=a.calcHeightFrozenRows(),q.css({height:a,zIndex:1}),d.css({width:v,top:a,position:"absolute"}),
l.css({top:-1*a}))}};c._generateTables=function(a,b,d){var l=this.that,q=l.colModel,s=l.options,v=s.virtualX,e=l.initH,c=l.finalH,f=s.numberCell,h=s.columnBorders,g=s.rowBorders,m=s.wrap,k=s.groupModel,p=s.freezeCols,s=parseInt(s.freezeRows),r=!1,n=0,x=d?d.data.length-1:b,A=k?!0:!1,B=d&&d.data?d.data:A?l.dataGM:l.pdata,C=l.rowIndxOffset;if(d||null!=a&&null!=x){d||l._trigger("beforeTableView",null,{pageData:B,initV:a,finalV:b,initH:e,finalH:c,colModel:q});r="pq-grid-table ";h&&(r+="pq-td-border-right ");
g&&(r+="pq-td-border-bottom ");h=["<table class='"+(m?r+"pq-wrap ":r+"pq-no-wrap ")+"' cellpadding=0 cellspacing=0 >"];this.hidearrHS1=[];h.push("<tr class='pq-row-hidden'>");f.show&&(n=f.width+1,h.push("<td style='width:"+n+"px;' ></td>"));for(r=0;r<=c;r++){if(r<e&&r>=p&&(v||d)&&(r=e,r>c))throw"initH>finalH";n=q[r];n.hidden||(n=n.outerWidth,h.push("<td style='width:",n,"px;' pq-col-indx='",r,"'></td>"))}h.push("</tr>");this.offsetRow=null;for(n=0;n<=x;n++)n<a&&n>=s&&(n=a),v=B[n],e=A?v.rowIndx-C:
n,v&&v.pq_hidden||(r=l.lastFrozenRow===e,k&&v.groupTitle?this._generateTitleRow(k,v,h,r):k&&v.groupSummary?this._generateSummaryRow(v.data,q,h,r):(c=v.pq_detail&&v.pq_detail.show,this._generateRow(v,e,q,h,d,r,c),c&&this._generateDetailRow(v,e,q,h,d,r)));l.scrollMode=!1;h.push("</table>");return h.join("")}};c._renderCell=function(a,b){var d=this.options,l=a.rowData,q=a.column,s=q.type,q=q.dataIndx,e=l[q];if(l){void 0!=b?s=b:"checkBoxSelection"==s?s="<input type='checkbox' "+(e?"checked='checked'":
"")+" />":"detail"==s?(s=d.detailModel,s="<div class='ui-icon "+(e&&e.show?s.expandIcon:s.collapseIcon)+"'></div>"):s=e;if(""===s||void 0==s)s="&nbsp;";var e="",c;a.tree&&(c=d.treeModel)&&c.labelIndx==q?(d=!l.pq_collapse,q=(l.pq_level+1)*c.indent,e="",e=l.pq_leaf?c.leafIcon:d?c.expandIcon+" pq-tree-expand-icon":c.collapseIcon+" pq-tree-expand-icon",l=["<div class='pq-tree-icon-container' style='width:",q,"px;'><div class='ui-icon ",e," pq-tree-icon' ></div></div>"].join(""),e="<div class='"+cls+"'>"+
l+s+"</div>"):e=s;return e}};c.renderCell=function(a){var b=this.that,d=this.options,l=a.rowData,q=a.rowIndx,s=a.rowIndxPage,e=a.column,c=a.colIndx,f=e.dataIndx,h=d.freezeCols,g=d.columnBorders,k="pq-col-indx='"+c+"'",m=!1,p="pq-grid-cell ";"right"==e.align?p+=" pq-align-right":"center"==e.align&&(p+=" pq-align-center");c==h-1&&g&&(p+=" pq-last-freeze-col");(h=e.cls)&&(p=p+" "+h);(h=l.pq_cellselect)&&(m=h[f]);m&&(p+=" pq-cell-select ui-state-highlight");var r;e.render&&(r=e.render.call(b.element[0],
{data:b.pdata,dataModel:d.dataModel,rowData:l,cellData:l[f],rowIndxPage:s,rowIndx:q,colIndx:c,column:e,dataIndx:f}));(b=l.pq_cellcls)&&(b=b[f])&&(p+=" "+b);if(l=l.pq_cellattr)if(f=l[f])for(var n in f)l=f[n],"title"==n&&(l=l.replace(/\"/g,"&quot;")),k+=" "+n+'="'+l+'"';return["<td class='",p,"' ",k," >",this._renderCell(a,r),"</td>"].join("")};c.refreshRow=function(a,b,d){var l=this.that,q=l.pdata[a];this._generateRow(q,a,b,d,null,l.lastFrozenRow===a,q.pq_detail&&q.pq_detail.show)};c._generateRow=
function(a,b,d,l,q,s,e){var c="pq-grid-row";s&&(c+=" pq-last-freeze-row");e&&(c+=" pq-detail-master");var f=this.that,h=this.options;s=h.freezeCols;var g=h.numberCell;e=h.treeModel.labelIndx?!0:!1;var k=h.virtualX,m=f.initH,f=f.finalH,p=this.offset;h.stripeRows&&b/2==parseInt(b/2)&&(c+=" pq-grid-oddRow");a.pq_rowselect&&(c+=" pq-row-select ui-state-highlight");h=a.pq_rowcls;null!=h&&(c+=" "+h);var h=a.pq_rowattr,r="";if(h)for(var n in h)var z=h[n],z=z.replace('"',"&quot;"),r=r+(n+'="'+z+'"');l.push("<tr pq-row-indx='",
b,"' class='",c,"' ",r," >");g.show&&l.push(["<td class='pq-grid-number-cell ui-state-default'>",q?"&nbsp;":b+1,"</td>"].join(""));a={rowIndx:b+p,rowIndxPage:b,rowData:a};for(b=0;b<=f;b++){if(b<m&&b>=s&&(k||q)&&(b=m,b>f))throw"initH>finalH";c=d[b];c.hidden||(a.column=c,a.colIndx=b,a.tree=e,l.push(this.renderCell(a)))}l.push("</tr>");return l};c={widgetEventPrefix:"pqgrid"};c.options={cancel:"input,textarea,button,select,option,.ui-resizable-handle,div[contenteditable],.pq-draggable",distance:3,collapsible:{on:!0,
...
for(var a in this)delete this[a];g.fragments={}};c.decidePanes=function(){var a=this.pqpanes={v:!1,h:!1,vH:!1},b=this.options,d=b.virtualX,l=b.virtualXHeader,q=b.virtualY,s="flex"==b.height,e="flex"==b.width,c=b.numberCell,f=b.freezeRows,b=b.freezeCols;!f||s||!b&&!c.show||e?f&&!s?q||(a.h=!0):!b&&!c.show||e||(d||(a.v=!0,a.vH=!0),!1===l&&(a.vH=!0)):(q||(a.h=!0),d||(a.v=!0,a.vH=!0),!1===l&&(a.vH=!0))};c.collapse=function(a){var b=this,d=this.element,l=this.options.collapsible,q=l.$collapse.children("span"),
s=function(){q.addClass("ui-icon-circle-triangle-s").removeClass("ui-icon-circle-triangle-n");d.hasClass("ui-resizable")&&d.resizable("destroy");b.$toolbar.pqToolbar("disable");l.collapsed=!0;l._collapsed=!0;l.animating=!1;b._trigger("collapse")};a=a?a:{};if(l._collapsed)return!1;l.htCapture=d.height();!1===a.animate?(d.height(23),s()):(l.animating=!0,d.animate({height:"23px"},function(){s()}))};c.expand=function(a){var b=this,d=this.element,l=this.options.collapsible,q=l.htCapture,s=l.$collapse.children("span"),
e=function(){l._collapsed=!1;l.collapsed=!1;b._refreshResizable();l.refreshAfterExpand&&b.refresh();s.addClass("ui-icon-circle-triangle-n").removeClass("ui-icon-circle-triangle-s");b.$toolbar.pqToolbar("enable");l.animating=!1;b._trigger("expand")};a=a?a:{};if(!1===l._collapsed)return!1;!1===a.animate?(d.height(q),e()):(l.animating=!0,d.animate({height:q},function(){e()}))};c._createCollapse=function(){var a=this,b=this.$top,d=this.options.collapsible;d.$stripe||(b=g("<div class='pq-slider-icon' style='z-index:5;' ></div>").appendTo(b),
...
this.$footer=g("div.pq-grid-footer",d);this.$cont_o=g("div.pq-cont-right",this.$grid_inner);this.$cont_fixed=g("div.pq-cont-fixed",this.$grid_inner);d=this.$cont=g("div.pq-cont",this.$grid_inner);g(window).bind("resize"+a.eventNamespace+" orientationchange"+a.eventNamespace,function(b,d){a._onWindowResize(b,d)});d.on("click","td.pq-grid-cell",function(b){if(!0!==g.data(b.target,a.widgetName+".preventClickEvent")&&g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onClickCell(b)});d.on("click",
"tr.pq-grid-row",function(b){if(!0!==g.data(b.target,a.widgetName+".preventClickEvent")&&g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onClickRow(b)});d.on("contextmenu","td.pq-grid-cell",function(b){if(g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onRightClickCell(b)});d.on("contextmenu","tr.pq-grid-row",function(b){if(g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onRightClickRow(b)});d.on("dblclick","td.pq-grid-cell",function(b){if(g(b.target).closest(".pq-grid")[0]==
a.element[0])return a._onDblClickCell(b)});d.on("dblclick","tr.pq-grid-row",function(b){if(g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onDblClickRow(b)});d.on("mousedown","td.pq-grid-cell",function(b){if(g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onCellMouseDown(b)});d.on("mousedown","tr.pq-grid-row",function(b){if(g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onRowMouseDown(b)});d.on("mousedown",function(b){if(g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onContMouseDown(b)});
d.on("mouseenter","td.pq-grid-cell",function(b){if(g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onCellMouseEnter(b,g(this))});d.on("mouseenter","tr.pq-grid-row",function(b){if(g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onRowMouseEnter(b,g(this))});d.on("mouseleave","td.pq-grid-cell",function(b){if(g(b.target).closest(".pq-grid")[0]==a.element[0])return a._onCellMouseLeave(b,g(this))});d.on("mouseleave","tr.pq-grid-row",function(b){if(g(b.target).closest(".pq-grid")[0]==
a.element[0])return a._onRowMouseLeave(b,g(this))});d.bind("mousewheel DOMMouseScroll",function(b){return a._onMouseWheel(b)});this.$hvscroll=g("<div class='pq-hvscroll-square ui-widget-content'></div>").appendTo(this.$grid_inner);this.$vscroll=g("<div class='pq-vscroll'></div>").appendTo(this.$grid_inner);this.prevVScroll=0;d=b.scrollModel;void 0===d.lastColumn&&b.virtualX&&(d.lastColumn="auto");this.$vscroll.pqScrollBar({pace:d.pace,theme:d.theme,steps:b.virtualY,direction:"vertical",cur_pos:0,
pageDown:function(b,d){a.iKeyNav.pageDown()},pageUp:function(b,d){a.iKeyNav.pageUp()},drag:function(d,q){b.virtualY||a._syncViewWithScrollBarVert(q.ratio)},scroll:function(d,q){b.virtualY&&(a.scrollMode=!0,a.setFlexWHCallback(function(){a.iGenerateView.generateView()}),1>=(d.originalEvent&&"drag"==d.originalEvent.type?a._setScrollVNumEles():a._setScrollVNumEles(!0))&&(a._setScrollHLength(),a._setScrollHVLength()))}});this.$hscroll=g("<div class='pq-hscroll'></div>").appendTo(this.$grid_inner);this.$hscroll.pqScrollBar({direction:"horizontal",
pace:d.pace,theme:d.theme,steps:b.virtualX,cur_pos:0,drag:function(d,q){b.virtualX||a._syncViewWithScrollBarHor(q.ratio)},scroll:function(d,q){var s=b.virtualXHeader;b.virtualX&&a.refresh({header:!1===s?!1:!0});!1===s&&a._syncViewWithScrollBarHorHeader(q.cur_pos)}});this.element.height("");this.disableSelection();window.opera?this.$grid_inner.bind("keypress.pq-grid",{that:this},function(b){g(b.target).closest(".pq-grid")[0]==a.element[0]&&a._onKeyPressDown(b)}):this.$grid_inner.bind("keydown.pq-grid",
{that:this},function(b){g(b.target).closest(".pq-grid")[0]==a.element[0]&&a._onKeyPressDown(b)});this._refreshOptions();this._refreshTitle();this.iRows=new g.paramquery.cRows(this);this.iCells=new g.paramquery.cCells(this);this.generateLoading();this._initPager();this._refreshResizable();this._refreshDraggable();this._mouseInit()};c.toggle=function(){var a=this.options,b=a.collapsible,d=this.element,l=g(document.body);if("fixed"==d.css("position")){var q=this.maxim.eleObj,b=this.maxim.docObj;a.height=
q.height;a.width=q.width;d.css({position:q.position,left:q.left,top:q.top,margin:q.margin,zIndex:q.zIndex});l.css({height:b.height,width:b.width,overflow:b.overflow});g("html").css({overflow:"visible"});window.scrollTo(b.scrollLeft,b.scrollTop);a="min"}else q={height:a.height,width:a.width,position:d.css("position"),left:d.css("left"),top:d.css("top"),margin:d.css("margin"),zIndex:d.css("zIndex")},a.height="100%-2",a.width="100%-2",d.css(g.extend({position:"fixed",left:0,top:0,margin:0},b.css)),b=
{height:l.height(),width:l.width(),overflow:l.css("overflow"),scrollLeft:g(window).scrollLeft(),scrollTop:g(window).scrollTop()},g(document.body).css({height:0,width:0,overflow:"hidden"}),g("html").css({overflow:"hidden"}),window.scrollTo(0,0),this.maxim={eleObj:q,docObj:b},a="max";this._trigger("toggle",null,{state:a});this._refreshResizable();this.refresh();g(window).trigger("resize",{$grid:d,state:a})};c._mouseCapture=function(a){var b=this.options;if(b.virtualX&&b.virtualY||!a.target)return!1;
if(g(a.target).closest(".pq-grid")[0]==this.element[0]){if("flex"==b.height&&"flex"==b.width)return!1;a=b.swipeModel;return!1==a.on||"touch"==a.on&&!g.support.touch?!1:!0}return!1};c._saveDims=function(){var a=this.$cont;a.data("offsetWidth",a[0].offsetWidth);a.data("offsetHeight",a[0].offsetHeight);var b=this.$tbl;if(b)for(a=0;a<b.length;a++){var d=b[a],l=g(d);l.data("offsetHeight",d.offsetHeight);l.data("scrollWidth",d.scrollWidth)}if(b=this.$tbl_header)for(a=0;a<b.length;a++)d=b[a],l=g(d).parent(),
l.data("offsetHeight",d.offsetHeight),l.data("scrollWidth",d.scrollWidth)};c._mousePQUp=function(a){g(document).unbind("mouseup."+this.eventNamespace,this._mousePQUpDelegate);this._trigger("mousePQUp",a,null)};c._mouseDown=function(a){var b=this;if(g(a.target).closest(".pq-editor-focus").length)this._blurEditMode=!0,window.setTimeout(function(){b._blurEditMode=!1},0);else return this._saveDims(),this._mousePQUpDelegate=function(a){return b._mousePQUp(a)},g(document).bind("mouseup."+this.eventNamespace,
this._mousePQUpDelegate),this._super.call(this,a)};c._mouseStart=function(a){this.blurEditor({force:!0});return!0};c._mouseDrag=function(a){return!1==this._trigger("mouseDrag",a,null)?!1:!0};c._mouseStop=function(a){return!1==this._trigger("mouseStop",a,null)?!1:!0};c._refreshGridWidthAndHeight=function(){var a=this.options,b,d,l=-1<(a.width+"").indexOf("%")?!0:!1,q=-1<(a.height+"").indexOf("%")?!0:!1,s=this.element;if(l||q){var e=s.parent();if(!e.length)return;var c,f;e[0]==document.body||"fixed"==
s.css("position")?(c=g(window).width(),f=window.innerHeight?window.innerHeight:g(window).height()):(c=e.width(),f=e.height());var h=null,k=function(a){return(a=/(-|\+)([0-9]+)/.exec(a))&&3==a.length?parseInt(a[1]+a[2]):0},m=l?k(a.width):0,k=q?k(a.height):0;if(0==c){for(;"BODY"!=e[0].tagName.toUpperCase();){var p=e.parent();if(null==p[0]){h=e;break}else e=p}if(h){var p=h.css("position"),r=h.css("left"),n=h.css("top");h.css({position:"absolute",left:"-2000",top:"-2000"}).appendTo(g(document.body));
e=s.parent();l&&(c=e.width());q&&(f=e.height());h.css({position:p,left:r,top:n})}}l&&(b=parseInt(a.width)*c/100+m);q&&(d=parseInt(a.height)*f/100+k)}l||(b=a.width);q||(d=a.height);"auto"!=b&&b<a.minWidth&&(b=a.minWidth);d<a.minHeight&&(d=a.minHeight);s.width(b);s.height(d)};var h,k;c._onWindowResize=function(a,b){var d=this.options,l=this.element,q=l.parent();if(b){var s=b.$grid;if(s&&(s==l||0==l.closest(s).length))return}if(q.length&&(q[0]==document.body||"fixed"==l.css("position")?(l=window.innerHeight?
window.innerHeight:g(window).height(),q=g(window).width()):(l=q.height(),q=q.width()),null==h||l!=h||q!=k)&&(h=l,k=q,!(g.support.touch&&d.editModel.indices&&g(document.activeElement).is(".pq-editor-focus")))){var e=this,d=d.autoSizeInterval,d=void 0===d?0:d;this.autoResizeTimeout&&(clearTimeout(this.autoResizeTimeout),delete this.autoResizeTimeout);this.autoResizeTimeout=window.setTimeout(function(){e._refreshAfterResize();delete e.autoResizeTimeout},d)}};c._onMouseWheel=function(a){this._saveDims();
var b=this.options,d=0,l=!1;a=a.originalEvent;var q=a.wheelDeltaX,s=a.wheelDeltaY,e=a.wheelDelta;if(q&&Math.abs(q)>Math.abs(s)){if("flex"==b.width)return!0;l=!0;d=q/120}else if(e){if("flex"==b.height)return!0;d=e/120}else a.detail&&(d=-1*a.detail/3);a=l?this.$hscroll:this.$vscroll;q=a.pqScrollBar("option");s=parseInt(q.cur_pos);e=parseInt(q.num_eles);l&&b.virtualX||!l&&b.virtualY?(d=0<d?Math[1>d?"ceil":"floor"](d):Math[-1>d?"ceil":"floor"](d),0<=s-d&&(a.pqScrollBar("option","cur_pos",s-d),a.pqScrollBar("scroll"))):
(b=q.ratio-d/(e-1),1<b?b=1:0>b&&(b=0),a.pqScrollBar("option","ratio",b),a.pqScrollBar("drag"));return!1};c._onDblClickCell=function(a){var b=g(a.currentTarget),d=this.getCellIndices({$td:b}),l=d.rowIndxPage,q=l+this.rowIndxOffset,d=d.colIndx;if(null!=d){if(!1==this._trigger("cellDblClick",a,{$td:b,rowIndxPage:l,rowIndx:q,colIndx:d,column:this.colModel[d],rowData:this.pdata[l]}))return!1;1<this.options.editModel.clicksToEdit&&this.isEditableRow({rowIndx:q})&&this.isEditableCell({colIndx:d,rowIndx:q})&&
this.editCell({rowIndxPage:l,colIndx:d})}};c._onClickCont=function(a){};c._onClickRow=function(a){var b=g(a.currentTarget),d=parseInt(b.attr("pq-row-indx")),l=d+this.rowIndxOffset;if(!isNaN(d)&&!1==this._trigger("rowClick",a,{$tr:b,rowIndxPage:d,rowIndx:l,rowData:this.pdata[d]}))return!1};c._onRightClickRow=function(a){var b=g(a.currentTarget),d=parseInt(b.attr("pq-row-indx")),l=d+this.rowIndxOffset;if(!isNaN(d)&&!1==this._trigger("rowRightClick",a,{$tr:b,rowIndxPage:d,rowIndx:l,rowData:this.pdata[d]}))return!1};
c._onDblClickRow=function(a){var b=g(a.currentTarget),d=parseInt(b.attr("pq-row-indx")),l=this.getRowIndxOffset();if(!1==this._trigger("rowDblClick",a,{$tr:b,rowIndxPage:d,rowIndx:d+l,rowData:this.pdata[d]}))return!1};g.paramquery.getValueFromDataType=function(a,b,d){if("date"==b)return b=Date.parse(a),isNaN(b)?"":d?b:a;if("integer"==b)b=parseInt(a);else if("float"==b)b=parseFloat(a);else return"bool"==b?(b=g.trim(a).toLowerCase(),0==b.length?null:"true"==b||"yes"==b||"1"==b?!0:"false"==b||"no"==
b||"0"==b?!1:Boolean(b)):g.trim(a);return isNaN(b)||null==b?null==a?a:null:b};var e=function(a){this.that=a},f=e.prototype;f._isValidCell=function(a){var b=this.that,d=a.column,l=d.validations;if(!l||!l.length)return{valid:!0};var q=a.value,s=d.dataType,e=function(a){return g.paramquery.getValueFromDataType(a,s,!0)};a=a.rowData;if(!a)throw"rowData required.";for(var c=0;c<l.length;c++){var f=l[c],h=f.type,k=!1,p=f.msg,m=f.value;if(!1!==f.on&&(null==q&&"function"!=typeof h?k=!1:"minLen"==h?(q=e(q),
m=e(m),q.length>=m&&(k=!0)):"nonEmpty"==h?null!=q&&""!==q&&(k=!0):"maxLen"==h?(q=e(q),m=e(m),q.length<=m&&(k=!0)):"gt"==h?(q=e(q),m=e(m),q>m&&(k=!0)):"gte"==h?(q=e(q),m=e(m),q>=m&&(k=!0)):"lt"==h?(q=e(q),m=e(m),q<m&&(k=!0)):"lte"==h?(q=e(q),m=e(m),q<=m&&(k=!0)):"regexp"==h?(new RegExp(m)).test(q)&&(k=!0):"function"==typeof h?(m={column:d,value:q,rowData:a,msg:p},!1==h.call(b.element[0],m)?(k=!1,m.msg!=p&&(p=m.msg)):k=!0):k=!0,!k))return{valid:!1,msg:p,column:d,warn:f.warn,dataIndx:d.dataIndx,validation:f}}return{valid:!0}};
f.isValidCell=function(a){var b=this.that,d=a.rowData,l=a.rowIndx,q=a.value,s=a.valueDef,e=a.column,c=b.options,h=a.allowInvalid,f=e.dataIndx,m=c.validation,k=c.warning,p=c.editModel,r=p.invalidClass,p=p.warnClass,n=document.activeElement;if(a.checkEditable&&!1==b.isEditableCell({rowData:d,rowIndx:l,dataIndx:f}))return{valid:!0};a=this._isValidCell({column:e,value:q,rowData:d});var q=a.valid,e=a.warn,y=a.msg;if(q)b.data({rowData:d,dataIndx:f,data:"pq_valid"})&&(b.removeClass({rowData:d,rowIndx:l,
dataIndx:f,cls:p+" "+r}),b.removeData({rowData:d,dataIndx:f,data:"pq_valid"}));else var m=g.extend({},e?k:m,a.validation),z=m.css,x=m.cls,A=m.icon,B=m.style;if(h||e){if(q)return{valid:!0};b.addClass({rowData:d,rowIndx:l,dataIndx:f,cls:e?p:r});b.data({rowData:d,dataIndx:f,data:{pq_valid:{css:z,icon:A,style:B,msg:y,cls:x}}});return a}if(!q){l=null==l?b.getRowIndx({rowData:d}).rowIndx:l;if(null==l)return a;if(!s)b.goToPage({rowIndx:l}),b.editCell({rowIndx:l,dataIndx:f});else if(g(n).hasClass("pq-editor-focus")&&
(s=c.editModel.indices)){d=s.rowIndx;s=s.dataIndx;if(null!=l&&l!=d)throw"incorrect usage of isValid rowIndx: "+l;if(f!=s)throw"incorrect usage of isValid dataIndx: "+f;b.editCell({rowIndx:d,dataIndx:f})}if((b=b.getEditCell())&&b.$cell){var C=b.$cell;C.attr("title",y);try{C.tooltip("destroy")}catch(F){}C.tooltip({position:{my:"left center+5",at:"right center"},content:function(){return(""==A?"":"<span class='ui-icon "+A+" pq-tooltip-icon'></span>")+y},open:function(a,b){x&&b.tooltip.addClass(x);if(B){var d=
b.tooltip.attr("style");b.tooltip.attr("style",d+";"+B).css("zIndex",C.zIndex()+5)}z&&b.tooltip.css(z)}}).tooltip("open")}return a}if(s&&(b=b.getEditCell())&&b.$cell){C=b.$cell;C.removeAttr("title");try{C.tooltip("destroy")}catch(E){}}return{valid:!0}};c.isValid=function(a){return this.iIsValid.isValid(a)};f.isValid=function(a){var b=this.that;a=a||{};var d=a.allowInvalid,l=a.checkEditable,d=null==d?!1:d,q=a.dataIndx;if(null!=q){var s=b.columns[q],e=a.rowData||b.getRowData(a),c=a.hasOwnProperty("value"),
b=c?a.value:e[q],b=this.isValidCell({rowData:e,checkEditable:l,rowIndx:a.rowIndx,value:b,valueDef:c,column:s,allowInvalid:d});return b.valid||b.warn?{valid:!0}:b}if(null!=a.rowIndx||null!=a.rowIndxPage||null!=a.rowData)for(var e=a.rowData||b.getRowData(a),f=b.colModel,c=[],h=0,g=f.length;h<g;h++){if(s=f[h],!s.hidden&&(q=s.dataIndx,b=e[q],b=this.isValidCell({rowData:e,value:b,column:s,rowIndx:a.rowIndx,checkEditable:l,allowInvalid:d}),!b.valid&&!b.warn))if(d)c.push({rowData:e,dataIndx:q,column:s});
else return b}else{a=a.data?a.data:this.options.dataModel.data;c=[];if(!a)return null;h=0;for(g=a.length;h<g;h++){e=a[h];if(l&&(s=this.getRowIndx({rowData:e}).rowIndx,!1==b.isEditableRow({rowData:e,rowIndx:s})))continue;e=this.isValid({rowData:e,rowIndx:s,checkEditable:l,allowInvalid:d});if(!1===d){if(!e.valid)return e}else c=c.concat(e.cells)}}return d&&c.length?{cells:c,valid:!1}:{valid:!0}};c.isEditableRow=function(a){var b=this.options.editable;if(null!=b){if("function"==typeof b){var d=a.rowIndx;
a=a.rowData||this.getRowData({rowIndx:d});return b.call(this.element[0],{rowData:a,rowIndx:d})}return b}return!0};c.isEditableCell=function(a){var b=a.colIndx,d=a.dataIndx,b=null==b?this.getColIndx({dataIndx:d}):b,b=this.colModel[b],d=null==d?b.dataIndx:d,l=b.editable;if(a.checkVisible&&b.hidden)return!1;if(null!=l){if("function"==typeof l){var q=a.rowIndx;a=a.rowData||this.getRowData(a);return l.call(this.element[0],{rowIndx:q,rowData:a,column:b,dataIndx:d})}return l}return!0};c._getRowPQData=function(a,
b,d){return(d=null==d?this.pdata[a]:d)?d[b]:null};c._setRowPQData=function(a,b,d){if(d=null==d?this.pdata[a]:d)for(var l in b)d[l]=b[l]};c._onContMouseDown=function(a){this.blurEditor({blurIfFocus:!0});if(!1===this._trigger("contMouseDown",a,{dataModel:this.options.dataModel}))return!1;var b=g(a.target);a=b.closest(".pq-grid-cell");b=b.closest(".pq-grid-row");a.length||b.length||this.$cont.attr("tabindex",0).focus();return!0};c._onCellMouseDown=function(a){var b=g(a.currentTarget),d=this.getCellIndices({$td:b});
d.$td=b;d.dataModel=this.options.dataModel;return!1==this._trigger("cellMouseDown",a,d)?!1:!0};c._onRowMouseDown=function(a){var b=g(a.currentTarget),d=this.getRowIndx({$tr:b});d.$tr=b;d.dataModel=this.options.dataModel;return!1==this._trigger("rowMouseDown",a,d)?!1:!0};c._onCellMouseEnter=function(a,b){var d=this.options,l=this.getCellIndices({$td:b});if(null!=l.rowIndx&&null!=l.colIndx){if(!1===this._trigger("cellMouseEnter",a,l))return!1;"cell"==d.hoverMode&&this.highlightCell(b);return!0}};c._onRowMouseEnter=
function(a,b){var d=this.options,l=this.getRowIndx({$tr:b}),q=l.rowIndxPage;if(!1===this._trigger("rowMouseEnter",a,l))return!1;"row"==d.hoverMode&&this.highlightRow(q);return!0};c._onCellMouseLeave=function(a,b){"cell"==this.options.hoverMode&&this.unHighlightCell(b);return!0};c._onRowMouseLeave=function(a,b){var d=this.getRowIndx({$tr:b}).rowIndxPage;"row"==this.options.hoverMode&&this.unHighlightRow(d);return!0};c._onCellMouseUp=function(a){var b=g(a.currentTarget),d=this.getCellIndices({$td:b});
d.$td=b;d.dataModel=this.options.dataModel;return!1==this._trigger("cellMouseUp",a,d)?!1:!0};c._onRowMouseUp=function(a){var b=g(a.currentTarget),b=this.getRowIndx({$tr:b});return!1==this._trigger("rowMouseUp",a,b)?!1:!0};c._onClickCell=function(a){var b=this.colModel,d=this.options.editModel,l=g(a.currentTarget),q=this.getCellIndices({$td:l}),s=q.rowIndxPage,e=s+this.rowIndxOffset,c=q.colIndx;q.rowIndx=e;if(null!=c){var b=b[c],f=b.dataIndx;q.dataIndx=f;q.evt=a;if(!1==this._trigger("cellClick",a,
{$td:l,rowIndxPage:s,rowIndx:e,colIndx:c,dataIndx:f,column:b,rowData:this.pdata[s]}))return!1;1==d.clicksToEdit&&this.isEditableRow({rowIndx:e})&&this.isEditableCell({colIndx:c,rowIndx:e})&&this.editCell(q)}};c._onRightClickCell=function(a){var b=g(a.currentTarget),d=this.getCellIndices({$td:b}),l=d.rowIndxPage,q=l+this.rowIndxOffset,d=d.colIndx,s=this.colModel;if(null!=d&&(s=s[d],!1==this._trigger("cellRightClick",a,{$td:b,rowIndxPage:l,rowIndx:q,colIndx:d,dataIndx:s.dataIndx,column:s,rowData:this.pdata[l]})))return!1};
c.highlightCell=function(a){a.addClass("pq-grid-cell-hover ui-state-hover")};c.unHighlightCell=function(a){a.removeClass("pq-grid-cell-hover ui-state-hover")};c.highlightRow=function(a){isNaN(a)||(a=this.getRow({rowIndxPage:a}))&&a.addClass("pq-grid-row-hover ui-state-hover")};c.unHighlightRow=function(a){isNaN(a)||(a=this.getRow({rowIndxPage:a}))&&a.removeClass("pq-grid-row-hover ui-state-hover")};c._getCreateEventData=function(){return{dataModel:this.options.dataModel,data:this.pdata,colModel:this.options.colModel}};
c._refreshOptions=function(){this._refreshDataOptions()};c._refreshDataOptions=function(){};c.enableSelection=function(){this.$cont.enableSelection()};c.disableSelection=function(){this.$cont.disableSelection();this.$header_o.find("tr.pq-grid-title-row").disableSelection()};c._findCellFromEvt=function(a){a=g(a.target).closest(".pq-grid-cell");if(null==a||0==a.length)return{rowIndxPage:null,colIndx:null,$td:null};var b=this.getCellIndices({$td:a});b.$td=a;return b};c._initPager=function(){var a=this,
b={change:function(b,l){a.blurEditor({force:!0});var q=a.options.pageModel;void 0!=l.curPage&&(q.prevPage=q.curPage,q.curPage=l.curPage);void 0!=l.rPP&&(q.rPP=l.rPP);"remote"==q.type?a.remoteRequest({callback:function(){a._onDataAvailable({apply:!0})}}):a.refreshView()},refresh:function(b){a.refreshDataAndView()}};this.options.pageModel.type&&this.$footer.pqPager(b)};c._refreshHideArrHS=function(){for(var a=this.colModel,b=this.hidearrHS,d=this.initH,l=this.finalH,q=parseInt(this.options.freezeCols),
s=0;s<q;s++)b[s]=!1;for(s=q;s<d;s++)b[s]=!0;for(s=d;s<=l;s++)b[s]=!1;s=l+1;for(a=a.length;s<a;s++)b[s]=!0};c.generateLoading=function(){this.$loading&&this.$loading.remove();this.$loading=g("<div class='pq-loading'></div>").appendTo(this.element);g(["<div class='pq-loading-bg'></div><div class='pq-loading-mask ui-state-highlight'><div>",this.options.strLoading,"...</div></div>"].join("")).appendTo(this.$loading);this.$loading.find("div.pq-loading-bg").css("opacity",.2)};c._refreshLoadingString=function(){this.$loading.find("div.pq-loading-mask").children("div").html(this.options.strLoading)};
...
less:"Less Than",lte:"Less than or equal",great:"Great Than",gte:"Greater than or equal"};c.getQueryStringSort=function(){var a=this.iSort.sorters,b="",d=this.options,l=d.stringify;if(d.sql){for(d=0;d<a.length;d++)l=a[d],b+=(0<d?", ":"")+l.dataIndx+" "+("up"==l.dir?"asc":"desc");return b}return a.length?!1===l?a:JSON.stringify(a):""};c.getQueryStringCRUD=function(){return""};c.getQueryStringFilter=function(){var a=this.options,b=a.sql,d=a.stringify,l=a.filterModel,a=l.mode,q=this.getFilterData({CM:this.colModel,
location:"remote"}),s="";if(l&&l.on&&q)if(b){s=[];for(d=0;d<q.length;d++){var e=q[d],b=e.condition,l=e.dataIndx,e=g.trim(e.value);"contain"===b?s.push(l+" like '%"+e+"%'"):"notcontain"===b?s.push(l+" not like '%"+e+"%'"):"begin"===b?s.push(l+" like '"+e+"%'"):"end"===b?s.push(l+" like '%"+e+"'"):"equal"===b?s.push(l+"='"+e+"'"):"notequal"===b?s.push(l+"!='"+e+"'"):"empty"===b?s.push("isnull("+l+",'')=''"):"notempty"===b?s.push("isnull("+l+",'')!=''"):"less"===b?s.push(l+"<'"+e+"'"):"great"===b&&s.push(l+
">'"+e+"'")}s=s.join(" "+a+" ")}else q.length?(a={mode:a,data:q},s=!1===d?a:JSON.stringify(a)):s="";return s};c.remoteRequest=function(a){this.loading&&this.xhr.abort();var b=this,d="",l="",q=this.options,s=!1,e=this.colModel,c=q.dataModel,f=q.filterModel,h=q.pageModel;if("function"==typeof c.getUrl)(q=c.getUrl.call(this.element[0],{colModel:e,dataModel:c,groupModel:q.groupModel,pageModel:h,filterModel:f}))&&q.url&&(d=q.url),q&&q.data&&(l=q.data);else if("string"==typeof c.url){var d=c.url,l={},q=
{},m={};if("remote"==c.sorting){var k=this.getQueryStringSort();k&&(l={pq_sort:k})}"remote"==h.type&&(m={pq_curpage:h.curPage,pq_rpp:h.rPP});"local"!=f.type&&(k=this.getQueryStringFilter())&&(s=!0,q={pq_filter:k});var k=c.postData,p=c.postDataOnce;k&&"function"==typeof k&&(k=k.call(this.element[0],{colModel:e,dataModel:c}));l=g.extend({pq_datatype:c.dataType},q,m,l,k,p)}d&&(this.loading=!0,this.showLoading(),this.xhr=g.ajax({url:d,dataType:c.dataType,async:null==c.async?!0:c.async,cache:c.cache,contentType:c.contentType,
type:c.method,data:l,beforeSend:function(a,d){if("function"==typeof c.beforeSend)return c.beforeSend.call(b.element[0],a,d)},success:function(d,l,q){"function"==typeof c.getData&&(d=c.getData.call(b.element[0],d,l,q));c.data=d.data;h.type&&"remote"==h.type&&(d.curPage&&(h.curPage=d.curPage),d.totalRecords&&(h.totalRecords=d.totalRecords));b.hideLoading();b.loading=!1;a&&a.callback&&a.callback();b._trigger("load",null,{dataModel:c,colModel:e});s&&b._trigger("filter",null,{type:"remote",dataModel:c,
...
(b.draggable("destroy"),this.$title.removeClass("pq-draggable"),a.unwrap(".pq-wrapper"))};c._refreshDraggable=function(){var a=this.element,b=this.$title;this.options.draggable?(b.addClass("pq-draggable"),a.parent(".pq-wrapper").length||a.wrap("<div class='pq-wrapper' />"),a.parent(".pq-wrapper").draggable({handle:b})):this._destroyDraggable()};c._refreshResizable=function(){var a=this,b=this.element,d=this.options,l=-1<(d.width+"").indexOf("%"),q=-1<(d.height+"").indexOf("%"),s="auto"==d.width,e=
"flex"==d.width,c="flex"==d.height;if(!d.resizable||(c||q)&&(e||l||s))this._destroyResizable();else{var f="e,s,se";if(c||q)f="e";else if(e||l||s)f="s";l=!0;b.hasClass("ui-resizable")&&(q=b.resizable("option","handles"),f==q?l=!1:this._destroyResizable());l&&b.resizable({helper:"ui-state-default",handles:f,minWidth:d.minWidth,minHeight:d.minHeight?d.minHeight:100,delay:0,start:function(a,b){g(b.helper).css({opacity:.5,background:"#ccc",border:"1px solid steelblue"})},resize:function(a,b){},stop:function(b,
l){var q=a.element,s=d.width,e=d.height,c=-1<(s+"").indexOf("%"),f=-1<(e+"").indexOf("%"),h="auto"==s,s="flex"==s,v=!1;f||"flex"==e||(v=!0,d.height=q.height());c||h||s||(v=!0,d.width=q.width());a.refresh();q.css("position","relative");v&&g(window).trigger("resize")}})}};c._refreshAfterResize=function(){var a=this.options,b=a.width,d=a.height,a=-1!=(b+"").indexOf("%")?!0:!1,b="auto"===b,d=-1!=(d+"").indexOf("%")?!0:!1;(a||b||d)&&this.refresh()};c.refresh=function(a){this._refresh(a)};c._refreshDataIndices=
function(){for(var a="JSON"==this.getDataType()?!0:!1,b={},d={},l={},q=this.colModel,s=q.length,e=0;e<s;e++){var c=q[e],f=c.dataIndx;null==f&&(f=a?"dataIndx_"+e:e,c.dataIndx=f);b[f]=c;d[f]=e;c.validations&&(l[f]=l)}this.columns=b;this.colIndxs=d;this.validations=l};c.refreshView=function(a){null!=this.options.editModel.indices&&this.blurEditor({force:!0});this.refreshDataFromDataModel();this.refresh(a)};c._refresh=function(a){a=a||{};var b=a.header,d=a.table;a=this.element;if(a[0].offsetWidth){this.$grid_inner[0].scrollTop=
0;var l=this.options;this.decidePanes();l.collapsible._collapsed=!1;var q=this;this._refreshGridWidthAndHeight();this.iRefreshColumn.refreshColumnWidths();this._setScrollHNumEles();this._bufferObj_calcInitFinalH();this._refreshHideArrHS();!1!==b?this._createHeader():this._refreshHeader();this._refreshHeaderSortIcons();this._refreshPager();this._setInnerGridHeight();this._setRightGridHeight();a.height("");this.setFlexWHCallback(function(){!1!==d?q.iGenerateView.generateView():(q._saveDims(),q.iGenerateView.scrollView())});
...
l[0].offsetWidth-(b?2*b:1),q=l[0].offsetHeight-(b?2*b:1),s=this.element.offset(),l=l.offset();d.css({height:q,width:a,borderWidth:b,left:l.left-s.left-1,top:l.top-s.top-1})};c.setEditorPosTimer=function(){var a=this,b=this.options;this._refreshEditorPosTimer&&(window.clearInterval(this._refreshEditorPosTimer),this._refreshEditorPosTimer=null);this._refreshEditorPosTimer=window.setInterval(function(){b.editModel.indices&&a.refreshEditorPos()},200)};c._onHeaderCellClick=function(a,b){var d=this.colModel[a],
l=this.options,q=d.dataIndx;!1!==this._trigger("headerCellClick",b,{column:d,colIndx:a,dataIndx:q})&&l.sortable&&!1!=d.sortable&&this.sort({colIndx:a,column:d,dataIndx:q})};c._selectRow=function(a,b){this.selectRow(a,b)};c._findfirstUnhiddenColIndx=function(){for(var a=0;a<this.colModel.length;a++)if(!this.colModel[a].hidden)return a};c.selectRow=function(a){var b=a.evt;if(b&&("keydown"==b.type||"keypress"==b.type)){if(!1==this.iRows.replace(a))return!1}else if(!1==this.iRows.add(a))return!1;return!0};
c.get$Tbl=function(a,b){var d=this.$tbl,l=[];if(d&&d.length){var q=this.pqpanes,s=this.options,e=s.freezeRows,s=s.freezeCols;q.h&&q.v?null==b?a>=e?l.push(d[2],d[3]):l.push(d[0],d[1]):l=b>=s&&a>=e?d[3]:b<s&&a>=e?d[2]:b>=s&&a<e?d[1]:d[0]:l=q.v?null==b?d:b>=s?d[1]:d[0]:q.h?a>=e?d[1]:d[0]:d[0];if(l)return g(l)}};c.scrollCell=function(a){this.scrollRow(a);this.scrollColumn(a)};c.scrollY=function(a){this.$vscroll.pqScrollBar("option","cur_pos",a).pqScrollBar("scroll")};c.scrollRow=function(a){if(!this.pdata||
a.rowIndxPage>=this.pdata.length)return!1;this.options.virtualY?this._scrollRowVirtualY(a):this._scrollRowNonVirtualY(a)};c._scrollRowNonVirtualY=function(a){var b=this.options,d=a.rowIndxPage,l=this.iHierarchy?!0:!1,q=a.rowIndx;a=this.$cont.data("offsetHeight")-this._getScollBarHorizontalHeight();d=null==d?q-this.rowIndxOffset:d;b=parseInt(b.freezeRows);if(!(d<b)){var b=this.get$Tbl(d),s=this.getRow({rowIndxPage:d});if(d=s[0]){var q=d.offsetTop+parseInt(b.css("marginTop")),e=d.offsetHeight;l&&(l=
s.next("tr.pq-detail-child"))&&l.length&&(e+=l[0].offsetHeight);d.offsetTop<-1*b[0].offsetTop?(l=-1*d.offsetTop-parseInt(b.css("top")),b.css("marginTop",l),this._syncScrollBarVert()):q+e>=a&&(l=a-e-d.offsetTop,b.css("marginTop",l),this._syncScrollBarVert())}}};c._scrollRowVirtualY=function(a){var b=this.options,d=a.rowIndxPage,l=this.iHierarchy?!0:!1,q=a.rowIndx;a=this.scrollCurPos;d=null==d?q-this.rowIndxOffset:d;q=parseInt(b.freezeRows);if(!(d<q)&&(b=this._calcCurPosFromRowIndxPage(d),null!=b)){b<
...
!f.hasClass("pq-last-freeze-row")&&h>g-m-c){f=h-(g-m-c);c=e.children().children("tr");h=e=0;q?(q=c.filter("tr.pq-last-freeze-row").last().next(),0==q.length&&(q=c.filter("tr.pq-row-hidden").next())):q=c.filter("tr.pq-row-hidden").next();do{e+=q[0].offsetHeight;if(q[0]==d[0])break;else if(l&&!1!=q.hasClass("pq-detail-child")||h++,e>=f)break;q=q.next()}while(1);l=a+h;l>b&&(l=b);a=this.$vscroll.pqScrollBar("option","num_eles");a<l+1&&(a=l+1);this.$vscroll.pqScrollBar("option",{num_eles:a,cur_pos:l}).pqScrollBar("scroll")}}}};
...
a.vH?g(b[1]):g(b[0]),b.parent()};c.blurEditor=function(a){if(this.$div_focus){var b=this.$div_focus.find(".pq-editor-focus");if(a&&a.blurIfFocus)document.activeElement==b[0]&&b.blur();else return b.triggerHandler("blur",a)}};c._syncViewWithScrollBarVert=function(a){if(null!=a){var b=this.getTableForVertScroll();if(b&&b.length){var d=this.options;d.editModel.indices&&this.blurEditor({force:!0});var l=b.data("offsetHeight"),q=this.$cont.data("offsetHeight")-this._getScollBarHorizontalHeight();a=-1*
(l-q)*a-1;if((!l||!q)&&d.debug)throw"_syncViewWithScrollBarVert !tblHt || !contHt";-1<a&&(a=-1);b.css({marginTop:a})}}};c._syncViewWithScrollBarHor=function(a){if(null!=a){var b=this.getTableForHorScroll(),d=this.getTableHeaderForHorScroll();if(b||d){this.options.editModel.indices&&this.blurEditor({force:!0});var l=(b?b:d).data("scrollWidth"),q=this.$cont.data("offsetWidth")-this._getSBWidth();a*=-1*(l-q);l&&q&&(0<a&&(a=0),b&&b.css("marginLeft",a),d&&d.css("marginLeft",a))}}};c._syncViewWithScrollBarHorHeader=
function(a){if(null!=a){var b=this.getTableHeaderForHorScroll();if(b){var d=this.options,l=d.freezeCols;d.editModel.indices&&this.blurEditor({force:!0});var d=b.data("scrollWidth"),q=this.$cont.data("offsetWidth")-this._getSBWidth();a=m.call(this,l,a+l);a*=-1;d&&q&&(0<a&&(a=0),b.css("marginLeft",a))}}};c._syncScrollBarVert=function(){var a=this.getTableForVertScroll();if(a&&a.length){var b=a.data("offsetHeight"),d=this.$cont.data("offsetHeight")-this._getScollBarHorizontalHeight(),b=b-d,a=(-1*parseInt(a.css("marginTop"))-
...
this.refreshDataAndView())}};c.setSelection=function(a){if(null==a)return this.iRows.removeAll({raiseEvent:!0}),this.iCells.removeAll({raiseEvent:!0}),!1;var b=this.pdata,d,l;if(a.rowData)d=this.getRowIndx(a).rowIndx;else{var q=this.rowIndxOffset;d=a.rowIndx;l=a.rowIndxPage;d=null==d?l+q:d}q=null==a.colIndx&&void 0!==a.dataIndx?this.getColIndx({dataIndx:a.dataIndx}):a.colIndx;if(0>d||0>q||q>=this.colModel.length||null==b||0==b.length)return!1;a.rowIndx=d;a.colIndx=q;this._bringPageIntoView(a);l=d-
this.rowIndxOffset;a.rowIndxPage=l;this.scrollRow({rowIndxPage:l});if(null==q)return this._selectRow(a);this.scrollColumn({colIndx:q});return this.selectCell(a)};c.getColModel=function(){return this.colModel};c.saveEditCell=function(a){var b=this.options,d=b.editModel;if(!d.indices)return null;var l=g.extend({},d.indices),d=a?a.evt:null,q=l.rowIndxPage,e=q+this.rowIndxOffset,c=this.colModel[l.colIndx],l=c.dataIndx,f=this.pdata[q],h=b.dataModel,m;if(null==f)return null;m=f[l];if(null!=q){var k=this.getEditCellData();
"<br>"==k&&(k="");null==m&&""===k&&(k=null);c={rowIndx:e,rowIndxPage:q,dataIndx:l,column:c,newVal:k,value:k,oldVal:m,rowData:f,dataModel:h};if(!1===this._trigger("cellBeforeSave",d,c))return!1;f={};f[l]=k;if(!1===this.updateRow({row:f,rowIndx:e,refresh:!1,silent:!0,source:"edit",checkEditable:!1}))return!1;this._trigger("cellSave",d,c);"flex"==b.height?(this._setGridHeightFromTable(),this._fixIEFooterIssue()):a&&this.scrollRow({rowIndxPage:q});return!0}};c._addInvalid=function(a){};c._digestData=
function(a){if(!1===this._trigger("beforeValidate",null,a))return!1;var b=this.options,d=b.editModel,l=b.dataModel,q=l.data,e=b.colModel,c=b.pageModel,f=b.historyModel,h=a.validate,h=null==h?d.validate:h,m=c.type,k=a.allowInvalid,k=null==k?d.allowInvalid:k,p=b.trackModel,d=a.track,d=null==d?null==b.track?p.on:b.track:d,r=a.history,r=null==r?f.on:r,n=a.checkEditable,n=null==n?!0:n,w=a.checkEditableAdd,w=null==w?n:w,y=this.columns,z=this.colIndxs,x=a.source,f=this.rowIndxOffset,A=g.paramquery.getValueFromDataType,
p=a.rowList,B=p.length;q||(q=b.dataModel.data=[]);for(var C=[],F=0;F<B;F++){var E=p[F],G=E.newRow,I=E.rowData,K=E.type,O=E.checkEditable,P=E.rowIndx,S=E.oldRow;null==O&&("update"==K?O=n:"add"==K&&(O=w));if("update"==K){if(!S||!I)throw"assert failed: oldRow and rowData required while update";if(O&&!0!==b.editable&&!1===this.isEditableRow({rowIndx:P,rowData:I}))continue}else if("delete"==K){C.push(E);continue}if("add"==K)for(var Q=0,T=e.length;Q<T;Q++){var R=e[Q],N=R.dataIndx;G[N]=G[N]}for(N in G){R=
...
delete G[N];continue}}"update"==K&&(S[N]=U)}if(G)if("update"==K)for(N in G){C.push(E);break}else C.push(E)}p=a.rowList=C;B=p.length;if(!B)return!1;r&&(this.iHistory.increment(),this.iHistory.push({rowList:p}));for(F=0;F<B;F++)if(E=p[F],K=E.type,G=E.newRow,P=E.rowIndx,b=E.rowIndxPage,I=E.rowData,"update"==K)for(N in d&&this.iUCData.update({rowData:I,row:G,refresh:!1}),G)Q=G[N],I[N]=Q;else if("add"==K)d&&this.iUCData.add({rowData:G}),null==P&&null==b?q.push(G):(b=P-f,b="remote"==m?b:P,q.splice(b,0,
G)),"remote"==m&&c.totalRecords++;else if("delete"==K){b=this.getRowIndx({rowData:I});e=b.uf;P=b.rowIndx;if(d)this.iUCData["delete"]({rowIndx:P,rowData:I});b=P-f;b="remote"==m?b:P;e?l.dataUF.splice(b,1):(b=q.splice(b,1))&&b.length&&"remote"==m&&c.totalRecords--}this._trigger("change",null,a);return!0};c._fixTableViewPort=function(){var a=this.element[0];a.scrollTop=0;a.scrollLeft=0;a=this.$header_o[0];a.scrollLeft=0;a.scrollTop=0;this.iGenerateView.setPanes()};c._fixIEFooterIssue=function(){g(".pq-grid-footer").css({position:"absolute"});
g(".pq-grid-footer").css({position:"relative"})};c.refreshColumn=function(a){var b=this.colModel,d=a.colIndx,l=a.dataIndx,d=null==d?this.getColIndx({dataIndx:l}):d,l=null==l?b[d]:l,q=this.rowIndxOffset;a.colIndx=d;for(var e=this.initV,c=this.finalV,f=e;f<=c;f++){var h=f;a.rowIndx=h+q;a.rowIndxPage=h;a.colIndx=d;a.column=b[d];a.skip=!0;this.refreshCell(a)}this._fixTableViewPort();this._refreshScrollbars();this._trigger("refreshColumn",null,{dataModel:this.options.dataModel,colModel:b,initV:e,finalV:c,
colIndx:d,dataIndx:l})};c.refreshCell=function(a){if(this.pdata){var b=this.rowIndxOffset,d=a.skip,l=a.rowIndx,q=a.rowIndxPage,l=a.rowIndx=null==l?q+b:l,q=a.rowIndxPage=null==q?l-b:q,b=a.dataIndx,e=a.colIndx,e=a.colIndx=null==e?this.getColIndx({dataIndx:b}):e,c=this.getCell({all:!0,rowIndxPage:q,colIndx:e}),f=a.column,h=this.colModel;a.column=f?f:h[e];var g=this.options.treeModel;if(f=this.pdata[q])a.tree=g.labelIndx?!0:!1,a.rowData=f,c&&0<c.length&&(a=this.iGenerateView.renderCell(a),c.replaceWith(a),
d||(this._fixTableViewPort(),this._refreshScrollbars(),this._trigger("refreshCell",null,{dataModel:this.options.dataModel,colModel:h,rowData:f,rowIndx:l,rowIndxPage:q,colIndx:e,dataIndx:b})))}};c.refreshRow=function(a){if(this.pdata){var b=this.rowIndxOffset,d=a.rowIndx;a=a.rowIndxPage;d=null==d?a+b:d;a=null==a?d-b:a;var b=this.getRow({all:!0,rowIndxPage:a}),l=this.colModel,e=this.pdata[a],s=!1,c=document.activeElement;g(c);if(c==b[0]||1<b.length&&c==b[1])s=!0;if(!e||!b||!b.length)return null;c=[];
this.iGenerateView.refreshRow(a,l,c);l=c.join("");b.replaceWith(l);this._fixTableViewPort();this._refreshScrollbars();s&&this.getRow({all:!0,rowIndxPage:a}).attr("tabindex",0).focus();this._trigger("refreshRow",null,{rowData:e,rowIndx:d,rowIndxPage:a});return!0}};c.quitEditMode=function(a){if(!this._quitEditMode){var b=!1,d=!1,l=!1,e=this.options.editModel,s=e.indices,c=void 0;this._quitEditMode=!0;a&&(b=a.old,d=a.silent,l=a.fireOnly,c=a.evt);s&&(d||b||this._trigger("editorEnd",c,s),l||(this._removeCellRowOutline(a),
...
this.colModel,d=0;d<b.length;d++)if(a.colIndx=d,this.isEditableCell(a)&&!b[d].hidden)return d;return-1};c.editFirstCellInRow=function(a){var b=this.rowIndxOffset,d=a.rowIndx;a=a.rowIndxPage;d=null==d?a+b:d;a=null==a?d-b:a;b=this.getFirstEditableColIndx({rowIndx:d});-1!=b&&this.editCell({rowIndxPage:a,colIndx:b})};c._editCell=function(a){var b=this,d=a.evt,l=this.rowIndxOffset,e=a.rowIndxPage,s=a.rowIndx,s=null==s?e+l:s,e=null==e?s-l:e,l=a.colIndx,c=a.dataIndx,l=null==l?this.getColIndx({dataIndx:c}):
l,f=this.colModel[l],c=f.dataIndx,h=f.editor,k=this.options,m=k.editModel,k=k.editor,p=h?g.extend({},k,h):k,h=b.pdata[e],k=!1;if(!this.pdata||e>=this.pdata.length)return!1;if(m.indices){var r=m.indices;if(r.rowIndxPage==e&&r.colIndx==l){this.refreshEditorPos();var n=this.$div_focus.find(".pq-editor-focus");window.setTimeout(function(){n.focus()},0);return!1}if(!1===this.blurEditor({evt:d}))return!1;this.quitEditMode({evt:d})}m.indices={rowIndxPage:e,rowIndx:s,colIndx:l,column:f,dataIndx:c};this._generateCellRowOutline();
r=this.$div_focus.children(".pq-editor-inner");"right"==f.align?r.addClass("pq-align-right"):"center"==f.align?r.addClass("pq-align-center"):r.addClass("pq-align-left");var w=h[c],y=p.type;a=null==a.select?p.select:a.select;var z=p.init,x="pq-editor-focus "+(p.cls?p.cls:""),A=x+" pq-cell-editor ",B=p.attr?p.attr:"",C=p.style,F=(C=C?C:"")?"style='"+C+"'":"",E=r.width()-8,G="style='width:"+E+"px;"+C+"'",I=C?"style='"+C+"'":"",C={rowIndx:s,rowIndxPage:e,$cell:r,cellData:w,rowData:h,cls:x,dataIndx:c,
column:f};"function"==typeof y?p=y.call(b.element[0],C):"checkbox"==y?(p=p.subtype,r.html("<input "+(w?"checked='checked'":"")+" class='"+A+"' "+B+" "+I+" type=checkbox name='"+c+"' />"),E=r.children("input"),"triple"==p&&(E.pqval({val:w}),r.click(function(a){g(this).children("input").pqval({incr:!0})}))):"textarea"==y||"select"==y||"textbox"==y?("textarea"==y?p="<textarea class='"+A+"' "+B+" "+G+" name='"+c+"' ></textarea>":"select"==y?(y=(y=p.options)?y:[],"function"===typeof y&&(y=y.call(b.element[0],
{column:f,rowData:h})),A=[B," class='",A,"' ",G," name='",c,"'"].join(""),p=g.paramquery.select({options:y,attr:A,prepend:p.prepend,labelIndx:p.labelIndx,valueIndx:p.valueIndx,groupIndx:p.groupIndx})):p="<input class='"+A+"' "+B+" "+G+" type=text name='"+c+"' />",g(p).appendTo(r).width(E).val(w)):(r.html("<div contenteditable='true' tabindx='0' "+F+" "+B+" class='pq-editor-default "+x+"'></div>"),r.children().html(w),k=!0);"function"==typeof z&&z.call(b.element[0],C);var b=this,n=r.children(".pq-editor-focus"),
K=m.filterKeys;(w=f.editModel)&&void 0!==w.filterKeys&&(K=w.filterKeys);var O={$cell:r,$editor:n,dataIndx:c,column:f,colIndx:l,rowIndx:s,rowIndxPage:e,rowData:h};m.indices=O;n.data({FK:K}).on("click",function(a){g(this).focus()}).on("keydown",function(a){b.iKeyNav._keyDownInEdit(a)}).on("keypress",function(a){return b.iKeyNav._keyPressInEdit(a,{FK:K})}).on("keyup",function(a){return b.iKeyNav._keyUpInEdit(a,{FK:K})}).on("blur",function(a,d){var l=b.options.editModel,e=l.onBlur,q="save"==e,s="validate"==
e,c=l.cancelBlurCls,f=d?d.force:!1;if(!b._quitEditMode&&!b._blurEditMode&&l.indices){l=g(a.target);if(!f){if(!1===b._trigger("editorBlur",a,O)||!e||c&&l.hasClass(c))return;if(l.hasClass("hasDatepicker")){if(l.datepicker("widget").is(":visible"))return!1}else if(l.hasClass("ui-autocomplete-input")){if(l.autocomplete("widget").is(":visible"))return}else if(l.hasClass("ui-multiselect")){if(g(".ui-multiselect-menu").is(":visible")||g(document.activeElement).closest(".ui-multiselect-menu").length)return}else if(l.hasClass("pq-select-button")&&
(g(".pq-select-menu").is(":visible")||g(document.activeElement).closest(".pq-select-menu").length))return}b._blurEditMode=!0;if(!b.saveEditCell({evt:a,silent:f||q||!s})&&!f&&s)return b._deleteBlurEditMode(),!1;b.quitEditMode({evt:a});b._deleteBlurEditMode()}}).on("focus",function(a){b._trigger("editorFocus",a,O)});b._trigger("editorBegin",d,O);n.focus();window.setTimeout(function(){!1===g(document.activeElement).hasClass("pq-editor-focus")&&b.element.find(".pq-editor-focus").focus()},0);b.element[0].scrollLeft=
...
a=a.editor,a=e?g.extend({},a,e):a,s=b.dataIndx,e=this.$div_focus.children(".pq-editor-inner"),c;"function"==typeof a.getData?c=a.getData.call(this.element[0],{$cell:e,dataIndx:s,rowIndx:l,rowIndxPage:d,column:b}):(d=a.type,"checkbox"==d?(c=e.children(),c="triple"==a.subtype?c.pqval():c.is(":checked")?!0:!1):"contenteditable"==d?c=e.children().html():(d=e.find('*[name="'+s+'"]'))&&d.length?c=d.val():(d=e.find(".pq-editor-focus"))&&d.length&&(c=d.val()));return c};c.getCellIndices=function(a){var b=
...
e.type&&(b.scrollCell({rowIndx:d,colIndx:l}),b.iCells.extendSelection({rowIndx:d,colIndx:l,evt:a})):b.setSelection({rowIndx:d,colIndx:l,evt:a,setFirst:!0})};f._bodyKeyPressDown=function(a){var b=this.that,d,l,e=b.rowIndxOffset,c=this.options,f=b.colModel,h=c.selectionModel,k=c.editModel,m=a.ctrlKey||a.metaKey,p,r,n=g.ui.keyCode,t=a.keyCode;if(k.indices)b.$div_focus.find(".pq-cell-focus").focus();else{if("row"==h.type){l=m?b.iRows.getFocusSelection({old:!0}):b.iRows.getFocusSelection({old:!1});if(null==
l)return;p=l.rowIndx;c=p-e;if(null==p)return;if(!1==b._trigger("rowKeyDown",a,{rowData:b.pdata[c],rowIndx:p,rowIndxPage:c}))return!1}else if("cell"==h.type){d=m?b.iCells.getFocusSelection({old:!0}):b.iCells.getFocusSelection({old:!1});if(null==d)return;r=d;p=r.rowIndx;var c=p-e,w=r.dataIndx;r=b.getColIndx({dataIndx:w});if(null==p||null==r)return;if(!1==b._trigger("cellKeyDown",a,{rowData:b.pdata[c],rowIndx:p,rowIndxPage:c,colIndx:r,dataIndx:w,column:f[r]}))return!1;if(a.cancelBubble)return}else return;
if(t==n.LEFT){if(r=this._decrIndx(c,r))p=r.rowIndxPage+e,this.select({rowIndx:p,colIndx:r.colIndx,evt:a});a.preventDefault()}else if(t==n.RIGHT){if(r=this._incrIndx(c,r))p=r.rowIndxPage+e,this.select({rowIndx:p,colIndx:r.colIndx,evt:a});a.preventDefault()}else if(t==n.UP)c=this._decrRowIndx(c),null!=c&&this.select({rowIndx:c+e,colIndx:r,evt:a}),a.preventDefault();else if(t==n.DOWN)c=this._incrRowIndx(c),null!=c&&this.select({rowIndx:c+e,colIndx:r,evt:a}),a.preventDefault();else if(t==n.PAGE_DOWN||
t==n.SPACE){if(b=this.pageDown(c))c=b.rowIndxPage,null!=c&&this.select({rowIndx:c+e,colIndx:r,evt:a});a.preventDefault()}else if(t==n.PAGE_UP){if(b=this.pageUp(c))c=b.rowIndxPage,null!=c&&this.select({rowIndx:c+e,colIndx:r,evt:a});a.preventDefault()}else t==n.HOME?("row"==h.type||m?(p=b._getFirstVisibleRowIndxPage(b.pdata)+e,this.select({rowIndx:p,colIndx:r,evt:a})):"cell"==h.type&&(r=b._getFirstVisibleColIndx(),this.select({rowIndx:p,colIndx:r,evt:a})),a.preventDefault()):t==n.END?("row"==h.type||
m?(p=b._getLastVisibleRowIndxPage(b.pdata)+e,this.select({rowIndx:p,colIndx:r,evt:a})):"cell"==h.type&&(r=b._getLastVisibleColIndx(),this.select({rowIndx:p,colIndx:r,evt:a})),a.preventDefault()):t==n.ENTER?("row"==h.type?null!=l&&b.editFirstCellInRow({rowIndx:c+e}):null!=d&&(d=b.getCell({rowIndxPage:c,colIndx:r}))&&0<d.length&&(p=c+e,e=b.isEditableRow({rowIndx:p}),d=b.isEditableCell({rowIndx:p,colIndx:r}),e&&d&&b.editCell({rowIndxPage:c,colIndx:r})),a.preventDefault()):m&&"65"==t?("row"==h.type&&
"single"!=h.mode?b.iRows.selectAll({all:h.all}):"cell"==h.type&&"single"!=h.mode&&b.iCells.selectAll({all:h.all}),a.preventDefault()):k.pressToEdit&&32<=t&&127>=t&&!m&&null!=d&&(d=b.getCell({rowIndxPage:c,colIndx:r}))&&0<d.length&&(p=c+e,e=b.isEditableRow({rowIndx:p}),d=b.isEditableCell({rowIndx:p,colIndx:r}),e&&d&&b.editCell({rowIndxPage:c,colIndx:r,select:!0}))}};f.incrPageSize=function(){for(var a=this.that,b=a.$tbl,d=b.children("tbody").children("tr.pq-grid-row").not(".pq-group-row,.pq-summary-row"),
...
r=this.iHierarchy?!0:!1,n=this.options.detailModel.offset,w=0,y=r?this.$cont[0].offsetHeight:void 0;if(null==l||0==c)return{initV:k,finalV:k,tvRows:e,lastFrozenRow:k};for(var z=0,x=c>b?b:c;z<x;z++){var A=l[z],B=A.pq_hidden;B||(k=z,e++,r&&((A=A.pq_detail)&&A.show?(A=A.height||0,A>n&&(A=n),w+=A+22):w+=22))}if(c<b)return{initV:k,finalV:k,tvRows:e,lastFrozenRow:k};d-=e;z=b;for(x=c;z<x;z++)A=l[z],B=A.pq_hidden,m?p||(B?h++:g==d?p=!0:(h++,g++)):B?f++:g==a?(m=!0,h=f,g=0):(f++,g++),B||(e++,r&&m&&((A=A.pq_detail)&&
...
h=c,g=0,k=c;k<l;k++)if(d[k].hidden)h++;else if(g==e)break;else h++,g++;h>l-1&&(h=l-1);this.initH=h;if(f||!b)this.finalH=l-1;else{b=m.call(this,-1,c);e=this.$cont[0].offsetWidth-this._getSBWidth();for(k=h;k<l;k++)if(h=d[k],!h.hidden){h=h.outerWidth;if(!h&&a.debug)throw"outerwidth N/A";b+=h;if(b>e)break}a=k;a>l-1&&(a=l-1);this.finalH=a}}else this.initH=0,this.finalH=l-1};var m=function(a,b,d){var e=0,c=this.options,f=c.columnBorders?1:0,h=c.numberCell,c=this.colModel;-1==a&&(h.show&&(e=d?e+(parseInt(h.width)+
1):e+h.outerWidth),a=0);if(d)for(;a<b;a++){if(d=c[a],!d.hidden){if(!d._width)throw"assert failed";e+=d._width+f}}else for(;a<b;a++)d=c[a],d.hidden||(e+=d.outerWidth);return e};g.paramquery.pqgrid.calcWidthCols=m;c.calcHeightFrozenRows=function(){var a=this.$tbl,b=0;a&&a.length&&((a=g(a[0]).find("tr.pq-last-freeze-row"))&&a.length?(a=a[0],b=a.offsetTop+a.offsetHeight):b=0);return b};c._calcRightEdgeCol=function(a){var b=0,d=0,e=this.colModel,c=this.hidearrHS,f=this.options.numberCell;f.show&&(b+=f.outerWidth,
...
0,h=0,g=0;g<b;g++){var k;if(0==c)k=a[f];else{var m=e[c-1][g];k=m.colModel;if(null==k||0==k.length)k=m;else{for(var m=g-m.leftPos,p=0,r=0,n=0;n<k.length;n++)if(p+=0<k[n].childCount?k[n].childCount:1,m<p){r=n;break}k=k[r]}}m=k.childCount?k.childCount:1;g==h?(k.leftPos=g,e[c][g]=k,h+=m,a[f+1]&&f++):e[c][g]=e[c][g-1]}}return this.headerCells=e};c.getDataType=function(){var a=this.colModel;if(a&&a[0])return"string"==typeof a[0].dataIndx?"JSON":"ARRAY";throw"dataType unknown";};c.assignRowSpan=function(){for(var a=
...
f.autoLastColumn=function(){var a=this.that,b=a.options,d=b.columnBorders?1:0,e=a.colModel,c=e.length,b=b.freezeCols,f=a.$cont[0].offsetWidth-a._getSBWidth(),h=m.call(a,-1,b,!0),f=f-h,h=!1,a=a._getLastVisibleColIndx();if(null!=a&&(a=e[a],!a._percent)){for(var g=a._width,k,p=a._minWidth,r=a._maxWidth,c=c-1;c>=b;c--){var n=e[c];if(!n.hidden&&(n=n._width+d,f-=n,0>f)){h=!0;k=g+f>=p?g+f:g+n+f;break}}h||(k=g+f);k>r?k=r:k<p&&(k=p);a.width=a._width=k}};f.numericVal=function(a,b){return-1<(a+"").indexOf("%")?
parseInt(a)*b/100:parseInt(a)};f.refreshColumnWidths=function(){var a=this.that,b=a.options,d=b.numberCell,e="flex"==b.width,c=b.columnBorders?1:0,f=a.colModel,h=b.scrollModel,g=h.lastColumn,h=h.autoFit,k=a.$cont,p=f.length,m=a._getSBWidth(),r=b._minColWidth,n=b._maxColWidth;if(k&&k[0].offsetWidth){var t=k[0].offsetWidth,w=0;d.show&&(d.width<d.minWidth&&(d.width=d.minWidth),d.outerWidth=d.width+1,w=d.outerWidth);d=t-m-w;r=Math.floor(this.numericVal(r,d));n=Math.ceil(this.numericVal(n,d));m=0;if(5>
d||isNaN(d)){if(b.debug)throw"availWidth N/A";}else{delete a.percentColumn;for(b=0;b<p;b++)if(t=f[b],!t.hidden){var y=t.width,w=-1<(y+"").indexOf("%")?!0:null,z=t.minWidth,x=t.maxWidth,z=z?this.numericVal(z,d):r,x=x?this.numericVal(x,d):n;x<z&&(x=z);if(void 0!=y){var A=0;!e&&w?(a.percentColumn=!0,t.resizable=!1,t._percent=!0,y=this.numericVal(y,d)-c,A=Math.floor(y),m+=y-A,1<=m&&(A+=1,m-=1)):y&&(A=parseInt(y));A<z?A=z:A>x&&(A=x);t._width=A}else t._width=z;w||(t.width=t._width);t._minWidth=z;t._maxWidth=
x}k&&!1==e&&(h&&this.autoFit(),"auto"==g&&this.autoLastColumn());this._computeOuterWidths()}}};c._createHeader=function(){var a=this,b=this.options,d=b.hwrap,e=parseInt(b.freezeCols),c=b.numberCell,f=this.colModel,h=this.depth,k=b.virtualX,p=b.virtualXHeader,r=!1===p?a.initHH:a.initH,p=!1===p?a.finalHH:a.finalH,n=this.headerCells,H=this.$header,u=this.$header_o;if(null==p)throw"finalH required for _createHeader";if(!1===b.showHeader)H&&H.empty(),u.css("display","none");else{u.css("display","");H=
"pq-grid-header-table ";H=["<table class='"+(d?H+"pq-wrap ":H+"pq-no-wrap ")+"' cellpadding=0 cellspacing=0 >"];if(1<=h){H.push("<tr>");c.show&&H.push("<td style='width:"+(c.width+1)+"px;' ></td>");for(b=0;b<=p;b++){if(b<r&&b>=e&&k&&(b=r,b>p))throw"initH>finalH";d=f[b];d.hidden||(d=d.outerWidth,H.push("<td style='width:"+d+"px;' pq-col-indx="+b+"></td>"))}H.push("</tr>")}for(d=0;d<h;d++){H.push("<tr class='pq-grid-title-row'>");0==d&&c.show&&H.push(["<td pq-grid-col-indx='-1' class='pq-grid-number-col' rowspan='",
h,"'><div class='pq-td-div'>",c.title?c.title:"&nbsp;","</div></td>"].join(""));for(b=0;b<=p;b++){if(b<r&&b>=e&&k&&(b=r,b>p))throw"initH>finalH";this._createHeaderCell(d,b,n,H,"pq-grid-col ",e,r,h)}H.push("</tr>")}this.ovCreateHeader(H,"pq-grid-col ");H.push("</table>");c=H.join("");u.empty();this.pqpanes.vH?u.append(["<span class='pq-grid-header pq-grid-header-left ui-state-default'>",c,"</span><span class='pq-grid-header ui-state-default'>",c,"</span>"].join("")):u.append(["<span class='pq-grid-header ui-state-default'>",
c,"</span>"].join(""));H=this.$header=g(".pq-grid-header",u);this.$tbl_header=H.children("table");d=m.call(this,-1,e);h=this.$header_left=g(H[0]);this.pqpanes.vH&&(h=this.$header_left=g(H[0]),c=this.$header_right=g(H[1]),h.css({width:d,zIndex:10}),e=m.call(this,e,r),c.css({left:-1*e+"px"}));H.click(function(b){return a._onHeaderClick(b)});this._refreshResizeColumn(r,p,f);this._trigger("refreshHeader",null,null)}};c._onHeaderClick=function(a){if(!this.iDragColumns||"stop"==this.iDragColumns.status){var b=
g(a.target),d=b.closest(".pq-g-ficon");if(d.length)return b=d.attr("pq-col-indx"),a.stopImmediatePropagation(),this.iHeaderIconSearch.createDOM(b,d,a);d=b.closest("td.pq-grid-col");if(d.length&&(a.stopImmediatePropagation(),b=d.attr("pq-grid-col-indx"),null!=b))return this._onHeaderCellClick(b,a)}};c._createHeaderCell=function(a,b,d,e,c,f,h,g){var k=d[a][b],p=k.colSpan,m=k.halign,r=k.align,n=k.title;if(!(0<a&&k==d[a-1][b]||0<b&&k==d[a][b-1]||k.hidden)){d=c;null!=m?d+=" pq-align-"+m:null!=r&&(d+=" pq-align-"+
r);b==f-1&&1==g&&(d+=" pq-last-freeze-col");b<=f-1?d+=" pq-left-col":b>=h&&(d+=" pq-right-col");(f=k.cls)&&(d=d+" "+f);f="";if(null==k.colModel||0==k.colModel.length)f="pq-grid-col-indx='"+b+"'";e.push(["<td ",f," ","pq-col-indx="+b," ","pq-row-indx="+a,"  class='",d,"' rowspan=",k.rowSpan," colspan=",p,"><div class='pq-td-div'>",n?n:"","<span class='pq-col-sort-icon'>&nbsp;</span></div></td>"].join(""))}};c._refreshHeader=function(){for(var a=this.colModel,b=this.initH,d=this.finalH,e=g("table.pq-grid-header-table tr:first");b<=
d;b++)e.find("td[pq-col-indx="+b+"]").width(a[b].outerWidth)};c.ovCreateHeader=function(){};c._refreshResizeColumn=function(a,b,d){var e=this,c=this.options,f=c.filterModel.ficon?!0:!1,h=c.numberCell,k=e.$header.height(),c=parseInt(c.freezeCols),p=[],m=[];if(h.show&&h.resizable){var r=e.$header_left.find("td.pq-grid-number-col")[0],r=parseInt(r.offsetLeft)+(r.offsetWidth-10);p.push("<div pq-grid-col-indx='-1' style='left:",r,"px;height:",k,"px;' class='pq-grid-col-resize-handle'>&nbsp;</div>")}for(h=
0;h<=b;h++){if(h<a&&h>=c&&(h=a,h>b))throw"initH>finalH";var n=d[h];if(!n.hidden){var u=n.ficon,t=u||null==u&&f,u=p;if(!1!==n.resizable||t)r=e.$header_left,this.pqpanes.vH&&h>=c&&(r=e.$header_right,u=m),r=r.find("td[pq-grid-col-indx="+h+"]")[0],t=parseInt(r.offsetLeft),r=t+(r.offsetWidth-5);!1!==n.resizable&&u.push("<div pq-grid-col-indx='",h,"' style='left:",r,"px;height:",k,"px;' class='pq-grid-col-resize-handle'>&nbsp;</div>")}}e.$header_left.append(p.join(""));m.length&&e.$header_right.append(m.join(""));
...
c=0;c<e.length;c++)g(e[c]).on("focusin",a)};n._onCreateHeader=function(){var a=this.that,b=a.options,d=b.columnBorders;if(b.filterModel.header){this._bindFocus();var e=a.colModel,c=a.initH,f=a.finalH,h=b.freezeCols,b=b.virtualX,k=a.$tbl_header,p=g(k[0]),m=g(k[1]),r="input,select";if(1<k.length){p.find(r).css("visibility","hidden");for(var n=0;n<h;n++){var u=e[n],r="*[name='"+u.dataIndx+"']";p.find(r).css("visibility","visible");m.find(r).css("visibility","hidden")}}for(n=0;n<=f;n++){if(n<c&&n>=h&&
b&&(n=c,n>f))throw"initH>finalH";u=e[n];if(!u.hidden){var t=u.filter;if(t){var r=u.dataIndx,w=p;n>=h&&1<k.length&&(w=m);w=w.find("*[name='"+r+"']");if(0!=w.length){var y=t.type,z=t.value,x=t.value2;"checkbox"==y&&"triple"==t.subtype?w.pqval({val:z}):"select"==y&&(w.val(z),y=this.getWidth(u,d),w.css({width:y}));(y=t.init)&&y.call(w,{dataIndx:r,column:u});if(u=t.listeners)for(t=0;t<u.length;t++){y=u[t];"string"==typeof y&&(y=this[y+"Listener"]);for(var A in y)(function(b,d,e){b.bind(A,function(c){var l=
a.getColumn({dataIndx:e}),f=l.filter;"checkbox"==f.type?z="triple"==f.subtype?b.pqval({incr:!0}):b.is(":checked")?!0:!1:"between"==f.condition?(z=g(b[0]).val(),x=g(b[1]).val()):z=b.val();return d.call(this,c,{column:l,dataIndx:e,value:z,value2:x})})})(w,y[A],r)}}}}}}};n.getWidth=function(a,b){var d=parseInt(a.width)+(b?1:0);return d-15};n.createDOM=function(a,b){var d=this.that,e=d.initH,c=d.finalH,f=d.options,h=f.freezeCols,k=f.virtualX,p=d.colModel,m=d.element.zIndex()+5,r=f.columnBorders,f=f.numberCell;
a.push("<tr class='pq-grid-header-search'>");f.show&&a.push("<td pq-grid-col-indx='-1' class='pq-grid-number-col' rowspan='1'><div class='pq-grid-header-table-div'>&nbsp;</div></td>");for(f=0;f<=c;f++){if(f<e&&f>=h&&k&&(f=e,f>c))throw"initH>finalH";var n=p[f];if(!n.hidden){var u=b,t=n.halign;t||(t=n.align);"right"==t?u+=" pq-align-right":"center"==t&&(u+=" pq-align-center");(t=n.cls)&&(u=u+" "+t);if(t=n.filter){var w=n.dataIndx,y=t.type,z=t.value,x=t.condition,A=this.getWidth(n,r),B=t.cls,B="pq-search-hd-field "+
...
"")+"'>");p.show&&d.push("<td class='pq-grid-number-cell ui-state-default'>&nbsp;</td>");for(e=0;e<=c;e++){if(e<k&&e>=g&&h&&(e=k,e>c))throw"initH>finalH";var p=b[e],m=p.dataIndx;if(!p.hidden){var r="pq-grid-cell ";"right"==p.align?r+=" pq-align-right":"center"==p.align&&(r+=" pq-align-center");e==g-1&&f&&(r+=" pq-last-freeze-col");p.cls&&(r=r+" "+p.cls);p=["<td class='",r,"' style='' >",null==a[m]?"&nbsp;":a[m],"</td>"].join("");d.push(p)}}d.push("</tr>");return d},_generateDetailRow:function(a,b,
...
d=a[0]);return d};n.count=function(a){return a.length};n.sum=function(a,b){var d=0,e;e="float"===b?parseFloat:"integer"===b?parseInt:function(a){return a};for(var c=0,f=a.length;c<f;c++)d+=e(a[c]);"float"===b&&(d=d.toFixed(2));return d};n._groupData=function(){for(var a=this.that,b=a.pdata,d=a.options,e=d.groupModel,c=d.pageModel,d=a.colModel,c=c.type?(c.curPage-1)*c.rPP:0,f=d.length,h=e.dataIndx,k=h.length,p=e.collapsed,m=[],r=0;r<k;r++){m[r]=!1;for(var n=0;n<f;n++){var u=d[n],t=u.summary;if(t){var w=
t.type;if(w&&"function"==typeof w.push&&w[r]){m[r]=!0;break}}}}if(e&&b&&0<b.length){for(var e=[],n=[],y=[],z=[],x=[],r=0;r<k;r++)z[r]="",y[r]="",x[r]={};for(var A=0,B=b.length;A<=B;A++){for(var C=b[A],u=!1,F=null,r=0;r<k;r++)y[r]=A<B?g.trim(C[h[r]]):"",z[r]!=y[r]&&(u=!0),u&&null==F&&(F=r);if(u){for(u=0;u<k;u++)z[u]=y[u];if(0<A){for(r=k-1;r>=F;r--)if(m[r]){for(var E=[],G=0;G<f;G++)if(u=d[G],w=(t=u.summary)?t.type?t.type[r]:null:null){var I=u.dataIndx,K="",t=t.title?t.title[r]:null,O="{0}";"function"==
typeof w?K=w(x[r][I],u.dataType):(O=w+": {0}",K=this[w](x[r][I],u.dataType));t&&(O=t);E[I]=O.replace("{0}",K)}e.push({groupSummary:!0,level:r,data:E})}for(u=F;u<k;u++)e[n[u]].items=x[u][d[0].dataIndx].length}if(A==B)break;for(r=k-1;r>=F;r--)for(w=0;w<f;w++)u=d[w],x[r][u.dataIndx]=[];for(u=F;u<k;u++)e.push({groupTitle:y[u],level:u,GMRowIndx:e.length,collapsed:p&&null!=p[u]?p[u]:!1}),n[u]=e.length-1}if(A==B)break;C.rowIndx=A+c;C.pq_hidden=!1;e.push(C);for(F=0;F<f;F++)for(u=d[F],I=u.dataIndx,r=0;r<k;r++)x[r][I].push(C[I])}a.dataGM=
...
h=[],k=function(a,b,d){return"between"==a?null!=b&&""!==b||null!=d&&""!==d?!0:!1:-1!=g.inArray(a,c)?null!=b&&""!==b||-1==g.inArray(a,f)?!0:!1:!0},p=function(a,b){return"remote"==e?(null==a?"":a).toString():r.convert(a,b)},m=0;m<d;m++){var n=b[m],H=n.dataIndx,u=n.dataType,u=u&&"function"!=typeof u?u:"string",t=n.filter;if(a){if((t=n.filterModel)&&t.on){for(var w=[],y=t.mode,z=t.filters,n=0;n<z.length;n++){var t=z[n],x=t.value,A=t.condition;k(A,x)&&(x=p(x,u),w.push({value:x,condition:A}))}h.push({dataIndx:H,
...
b){if(a<b)return!0},lte:function(a,b){if(a<=b)return!0}};r.convert=function(a,b){a=null==a?"":a;"string"==b?a=g.trim(a).toUpperCase():"date"==b?a=Date.parse(a):"integer"==b?a=parseInt(a):"float"==b?a=parseFloat(a):"bool"==b&&(a=String(a).toLowerCase());return a};n.isMatchCellSingle=function(a,b){var d=a.dataType,e=a.value,c=a.value2,f=a.cbFn,h=b[a.dataIndx],h="regexp"==a.condition?null==h?"":h:r.convert(h,d);return f(h,e,c)?!0:!1};n.isMatchCellMultiple=function(a,b){var d=a.dataIndx,e=a.dataType,
...
c=c.rowData;for(var f=this.options.trackModel.dirtyClass,g=k.getRecId({rowData:c}),m=0,r=e.length;m<r;m++){var a=e[m];if(null!=g&&a.recId==g)throw"primary key violation";if(a.rowData==c)throw"same data can't be added twice.";}var m=[],b;for(b in c)m.push(b);k.removeClass({rowData:c,dataIndx:m,cls:f});c={recId:g,rowData:c};e.push(c)};c.update=function(c){var k=this.that,e=this.options.trackModel.dirtyClass,f=c.rowData||k.getRowData(c),p=k.getRecId({rowData:f}),m=c.dataIndx,r=c.refresh,a=k.columns,
b=g.paramquery.getValueFromDataType;c=c.row;var d=this.udata,l=d.slice(0),n=!1;if(null!=p){for(var s=0,v=d.length;s<v;s++){var D=d[s],L=D.oldRow;if(D.rowData==f){n=!0;for(m in c)d=a[m].dataType,v=c[m],v=b(v,d),D=L[m],D=b(D,d),L.hasOwnProperty(m)&&D===v?(d={rowData:f,dataIndx:m,refresh:r,cls:e},k.removeClass(d),delete L[m]):(d={rowData:f,dataIndx:m,refresh:r,cls:e},k.addClass(d),L.hasOwnProperty(m)||(L[m]=f[m]));g.isEmptyObject(L)&&l.splice(s,1);break}}if(!n){L={};for(m in c)L[m]=f[m],d={rowData:f,
dataIndx:m,refresh:r,cls:e},k.addClass(d);d={rowData:f,recId:p,oldRow:L};l.push(d)}this.udata=l}};c["delete"]=function(c){var k=this.that,e=c.rowIndx,f=c.rowIndxPage,g=k.rowIndxOffset,e=null==e?f+g:e,f="remote"==k.options.pageModel.type?null==f?e-g:f:e,g=this.adata,m=this.ddata;c=k.getRowData(c);for(var k=0,r=g.length;k<r;k++)if(g[k].rowData==c){g.splice(k,1);return}m.push({indx:f,rowData:c,rowIndx:e})};c.isDirty=function(c){var k=this.udata,e=this.adata,f=this.ddata,g=!1;if(c=this.that.getRowData(c))for(e=
0;e<k.length;e++){if(c==k[e].rowData){g=!0;break}}else if(k.length||e.length||f.length)g=!0;return g};c.getChangesValue=function(){for(var c=this.udata,k=this.adata,e=this.ddata,f={updateList:[],addList:[],deleteList:[]},p=[],m=[],r=[],a=[],b=[],d=0,l=e.length;d<l;d++){var n=e[d],n=n.rowData,s={};a.push(n);for(var v in n)0!=v.indexOf("pq_")&&(s[v]=n[v]);b.push(s)}for(d=0;d<c.length;d++)if(n=c[d],n=n.rowData,-1==g.inArray(n,a)&&-1==g.inArray(n,p)){s={};for(v in n)0!=v.indexOf("pq_")&&(s[v]=n[v]);p.push(n);
m.push(s)}for(d=0;d<k.length;d++){n=k[d];n=n.rowData;s={};for(v in n)0!=v.indexOf("pq_")&&(s[v]=n[v]);r.push(s)}f.updateList=m;f.addList=r;f.deleteList=b;return f};c.getChanges=function(){for(var c=this.udata,k=this.adata,e=this.ddata,f={updateList:[],addList:[],deleteList:[]},p=[],m=[],r=[],a=0,b=e.length;a<b;a++){var d=e[a],d=d.rowData;r.push(d)}a=0;for(b=c.length;a<b;a++)d=c[a],d=d.rowData,-1==g.inArray(d,r)&&-1==g.inArray(d,p)&&p.push(d);a=0;for(b=k.length;a<b;a++)d=k[a],d=d.rowData,m.push(d);
f.updateList=p;f.addList=m;f.deleteList=r;return f};c.getChangesRaw=function(){var c=this.adata,k=this.ddata,e={updateList:[],addList:[],deleteList:[]};e.updateList=this.udata;e.addList=c;e.deleteList=k;return e};c.commitAdd=function(c,k){for(var e=this.that.colModel,f=e.length,p=this.adata,m=g.inArray,r=p.length,a=g.paramquery.getValueFromDataType,b=[],d=c.length,l=[],n=0;n<d;n++)for(var s=c[n],v=0;v<r;v++){var D=p[v].rowData,L=!0;if(-1==m(D,l)){for(var M=0;M<f;M++){var J=e[M],H=J.dataType,u=J.dataIndx;
if(!J.hidden&&u!=k&&(J=D[u],J=a(J,H),u=s[u],u=a(u,H),J!==u)){L=!1;break}}if(L){v={};L={};v[k]=s[k];L[k]=D[k];b.push({type:"update",rowData:D,oldRow:L,newRow:v});l.push(D);break}}}e=[];for(v=0;v<r;v++)D=p[v].rowData,-1==m(D,l)&&e.push(p[v]);this.adata=e;return b};c.commitUpdate=function(c,k){for(var e=this.that,f=this.options.trackModel.dirtyClass,p=e.colModel,m=p.length,r=this.udata,a=r.length,b=c.length,d=[],l=0;l<a;l++){var n=r[l],s=n.rowData,n=n.oldRow;if(-1==g.inArray(s,d))for(var v=0;v<b;v++)if(s[k]==
c[v][k]){d.push(s);for(var D=0;D<m;D++)var L=p[D].dataIndx;for(L in n)e.removeClass({rowData:s,dataIndx:L,cls:f})}}e=[];for(l=0;l<a;l++)s=r[l].rowData,-1==g.inArray(s,d)&&e.push(r[l]);this.udata=e;return[]};c.commitDelete=function(c,k){for(var e=this.ddata,f=e.length,p=c.length,m=[],r=0;r<f;r++)for(var a=e[r].rowData,b=0;b<p;b++)a[k]==c[b][k]&&m.push(a);p=[];for(r=0;r<f;r++)a=e[r].rowData,-1==g.inArray(a,m)&&p.push(e[r]);this.ddata=p};c.commitUpdateAll=function(){for(var c=this.that,k=this.options.trackModel.dirtyClass,
e=this.udata,f=0,g=e.length;f<g;f++){var m=e[f],r=m.oldRow,m=m.rowData,a;for(a in r)c.removeClass({rowData:m,dataIndx:a,cls:k})}this.udata=[]};c.commitAddAll=function(){this.adata=[]};c.commitDeleteAll=function(){this.ddata=[]};c.commit=function(c){var k=this.that,e=c?c.history:null,e=null==e?!1:e,f=[],f=[],g=[],m=k.options.dataModel.recIndx;if(null==c)this.commitAddAll(),this.commitUpdateAll(),this.commitDeleteAll();else{var r=c.type;c=c.rows;"add"==r?c?f=this.commitAdd(c,m):this.commitAddAll():
"update"==r?c?g=this.commitUpdate(c,m):this.commitUpdateAll():"delete"==r&&(c?this.commitDelete(c,m):this.commitDeleteAll())}f=f.concat(g);f.length&&(k._digestData({source:"commit",checkEditable:!1,track:!1,history:e,rowList:f}),k.refreshView())};c.rollbackAdd=function(c,k){for(var e=this.adata,f=[],g=0,m=e.length;g<m;g++)f.push({type:"delete",rowData:e[g].rowData});this.adata=[];return f};c.rollbackDelete=function(c,k){for(var e=this.ddata,f=[],g=e.length-1;0<=g;g--){var m=e[g];f.push({type:"add",
rowIndx:m.rowIndx,newRow:m.rowData})}this.ddata=[];return f};c.rollbackUpdate=function(c,k){for(var e=this.that,f=this.options.trackModel.dirtyClass,g=this.udata,m=[],r=0,a=g.length;r<a;r++){var b=g[r],d=b.rowData,l={},n=b.oldRow;if(null!=b.recId){var b=[],s;for(s in n)l[s]=d[s],b.push(s);e.removeClass({rowData:d,dataIndx:b,cls:f,refresh:!1});m.push({type:"update",rowData:d,newRow:n,oldRow:l})}}this.udata=[];return m};c.rollback=function(c){var k=this.that,e=k.options.pageModel,f=c&&null!=c.refresh?
c.refresh:!0;c=c&&null!=c.type?c.type:null;var g=[],g=[],m=[],r=[],a=k.options.dataModel.data;if(null==c||"update"==c)m=this.rollbackUpdate(e,a);if(null==c||"delete"==c)g=this.rollbackDelete(e,a);if(null==c||"add"==c)r=this.rollbackAdd(e,a);g=g.concat(r,m);k._digestData({history:!1,allowInvalid:!0,checkEditable:!1,source:"rollback",track:!1,rowList:g});f&&k.refreshView()};c=g.paramquery.pqGrid.prototype;c.getChanges=function(c){this.blurEditor({force:!0});if(c&&(c=c.format)){if("byVal"==c)return this.iUCData.getChangesValue();
...
(function(g){g.widget("paramquery.pqToolbar",{options:{items:[],gridInstance:null},_create:function(){var c=this.options,n=c.gridInstance,h=n.colModel,k=c.items,e=this.element;e.closest(".pq-grid");e.addClass("pq-toolbar");for(var f=0,p=k.length;f<p;f++){var m=k[f],c=m.type,r=m.icon,a=m.label,b=m.listener,d=b?[b]:m.listeners,b=m.cls,b="ui-corner-all "+(b?b:""),l=m.style,l=l?'style="'+l+'"':"",q=m.attr,q=q?q:"",s;"textbox"==c?s=g("<input type='text' class='"+b+"' "+q+" "+l+">").appendTo(e):"checkbox"==
c?s=g("<input type='checkbox' class='"+b+"' "+q+" "+l+">").appendTo(e):"separator"==c?g("<span class='pq-separator '"+b+"' "+q+" "+l+"></span>").appendTo(e):"button"==c?(c=m.options?m.options:{},g.extend(c,{text:a?!0:!1,icons:{primary:r}}),s=g("<button type='button' class='"+b+"' "+q+" "+l+">"+a+"</button>").button(c).appendTo(e)):"select"==c?(c=m.options?m.options:[],"function"===typeof c&&(c=c.call(n.element[0],{colModel:h})),s=g.paramquery.select({options:c,attr:" class='"+b+"' "+q+" "+l,prepend:m.prepend,
groupIndx:m.groupIndx,valueIndx:m.valueIndx,labelIndx:m.labelIndx}),s=g(s).appendTo(e)):"string"==typeof c?s=g(c).appendTo(e):"function"==typeof c&&(s=c.call(n.element[0],{colModel:h,cls:b}),s=g(s).appendTo(e));if(d)for(m=0;m<d.length;m++){var b=d[m],v;for(v in b)s.bind(v,b[v])}}},_destroy:function(){this.element.empty().removeClass("pq-toolbar").enableSelection()},_disable:function(){null==this.$disable&&(this.$disable=g("<div class='pq-grid-disable'></div>").css("opacity",.2).appendTo(this.element))},
...
(function(g){var c=function(){this.focusSelection=null},n=c.prototype;n.triggerSelectChange=function(e){var c=this.that;if(c.options.selectionModel.fireSelectChange){var h=c.iRows.getSelection(),k=c.iCells.getSelection(),r=e.evt;e=e.ui;h={rows:h,cells:k};e=null==e?h:g.extend(h,e);c._trigger("selectChange",r,e)}};n.getOldRowSel=function(){var e=this.that,c;if((c=this.focusSelection)&&this.isSelected(c))return e=e.getRowIndx(c),e.rowData=c.rowData,e};n.getOldCellSel=function(){var e=this.that,c;if((c=
...
e.element[0])return e=e.getCellIndices({$td:c}),e.$td=c,e};n.getFocusSelection=function(c){if(this instanceof h)return c&&!0===c.old?this.getOldRowSel():this.getNewRowSel();if(this instanceof k)return c&&!0===c.old?this.getOldCellSel():this.getNewCellSel()};n.getFirstSelection=function(){var c=this.firstSelection;if(c&&this.isSelected(c))return c;this.refresh();c=this.selection;if(c.length)return this.firstSelection=c[0],c[0]};n.getLastSelection=function(){var c=this.lastSelection;if(c){var f=c.rowData,
h=this.that.getRowData({rowIndx:rowIndx});return f==h&&this.isSelected(c)?c:!1}return null};n.getLastSelectionCurPage=function(){var c=this.lastSelection;if(c&&this.isSelected(c)){var f=c.rowIndx,h=this.that.options.pageModel;if(h.type){var k=h.curPage;return Math.ceil((f+1)/h.rPP)==k?c:null}return c}return null};n.getSelection=function(){this.refresh();return this.selection};n.getSelectionCurPage=function(){var c=this.that,f=this.getSelection(),h=[],k=c.options.pageModel;if(k.type){for(var c=k.curPage,
k=k.rPP,g=0;g<f.length;g++){var a=f[g];Math.ceil((a.rowIndx+1)/k)==c&&h.push(a)}return h}return f};n.inViewRow=function(c){var f=this.that,h=this.options,k=f.rowIndxOffset,g=f.initV,a=f.finalV;if(c<h.freezeRows)return!0;if(h.groupModel){if((f=f.dataGM)&&f.length)for(;g<=a;g++)if(h=f[g].rowIndx-k,null!=h&&h==c)return!0;return!1}return c>=g&&c<=a};n.setDirty=function(){};var h=function(c){this.that=c;this.options=c.options;this.selection=[]};g.paramquery.cRows=h;var k=function(c){this.options=c.options;
this.that=c;this.selection=[]};g.paramquery.cCells=k;n=k.prototype=new c;c=h.prototype=new c;c.extendSelection=function(c){var f=this.that,h=c.rowIndx,k=f.options.selectionModel.mode;c=c.evt;var g=this.getFirstSelection();null==g?f.setSelection({rowIndx:h}):"single"!=k&&(k=f=g.rowIndx,g=h,f>h&&(k=h,g=f),this.selectRange({initRowIndx:k,finalRowIndx:g,evt:c}),this.add({rowIndx:h}))};c.refresh=function(){this.selection=[];var c=this.that,f=c.options,h="remote"==f.pageModel.type?!0:!1,c=c.rowIndxOffset,
...
c&&null==k||null==h)return null;k=null==k?f.colModel[c].dataIndx:k;return h.pq_cellselect&&h.pq_cellselect[k]?!0:!1};n.refresh=function(){this.selection=[];var c=this.that,f=c.options.dataModel.data,h=[],k="remote"==c.options.pageModel.type?!0:!1,c=c.rowIndxOffset,g=this.that.colModel,a=g.length;if(f){for(var b=[],d=0;d<a;d++){var l=g[d].dataIndx;b[d]=l}for(var d=0,n=f.length;d<n;d++){var s=f[d],v=s.pq_cellselect;if(v)for(var D=k?d+c:d,L=0;L<a;L++)l=b[L],v[l]&&h.push({rowIndx:D,rowData:s,dataIndx:l,
...
a=null==a?f.getColIndx({dataIndx:d}):a,l=f.colModel[a],d=null==d?l.dataIndx:d,n=c.evt,s=this.isSelected({rowData:g,dataIndx:d});if(null==s)return!1;var v=this.inViewCell(k,a);if(!1===s){if(v){var D=f.getCell({rowIndxPage:k,colIndx:a});D&&D.addClass("pq-cell-select ui-state-highlight")}this._addToData({rowData:g,dataIndx:d});!1!==c.trigger&&f._trigger("cellSelect",n,{rowIndx:h,rowIndxPage:k,colIndx:a,dataIndx:d,column:l,rowData:g});b=!0}this.lastSelection={rowIndx:h,dataIndx:d,rowData:g};!1!==c.focus&&
v&&(D&&D.length||(D=f.getCell({rowIndxPage:k,dataIndx:d})),D&&D.length&&(D.attr("tabindex","0"),D.focus(),f._fixTableViewPort(),this.focusSelection={rowData:g,rowIndx:h,dataIndx:d}));c.setFirst&&(this.firstSelection={rowIndx:h,rowData:g,dataIndx:d});if(b)return{rowIndx:h,rowData:g,dataIndx:d,colIndx:a,column:l}};c._add=function(c){var f=this.that,h,k=c.rowIndx,r=c.rowIndxPage,a=f.rowIndxOffset,k=null==k?r+a:k,r=null==r?k-a:r,b=null==b?f.getRowData(c):b,a=c.$tr,d=c.evt,l=this.isSelected({rowData:b});
c.rowIndxPage=r;if(null==l)return!1;var n=this.inViewRow(r);!1===l&&(n&&(a=this._boundRow(c)),b.pq_rowselect=!0,!1!==c.trigger&&f._trigger("rowSelect",d,{rowIndx:k,rowIndxPage:r,rowData:b,$tr:a}),h=!0);this.lastSelection={rowIndx:k,rowData:b};!1!==c.focus&&n&&(a&&a.length||(a=f.getRow({rowIndxPage:r})),a&&(a=g(a[0]),a.attr("tabindex","0"),a.focus(),f._fixTableViewPort(),this.focusSelection={rowData:b,rowIndx:k}));c.setFirst&&(this.firstSelection={rowIndx:k,rowData:b});if(h)return{rowIndx:k,rowData:b}};
...
!0:!1;c=h?this.options.dataModel.data:f.pdata;var k=f.rowIndxOffset,g=f.colModel,a=g.length,b=[],f=function(c,d){for(var e=0;e<a;e++){var f=g[e];f.hidden||b.push({rowIndx:d,rowData:c,colIndx:e,dataIndx:f.dataIndx,focus:!1})}};if(c){for(var d=0,l=c.length;d<l;d++)var n=c[d];if(h)for(h="remote"==this.options.pageModel.type?!0:!1,d=0,l=c.length;d<l;d++){var n=c[d],s=d;h&&(s=d+k);f(n,s)}else for(d=0,l=c.length;d<l;d++)n=c[d],s=d+k,f(n,s);this.add({cells:b})}};c.selectAll=function(c){var f=this.that,h=
c&&c.all?!0:!1,f=h?this.options.dataModel.data:f.pdata;c=[];if(f){if(h)for(var h="remote"==this.options.pageModel.type?!0:!1,k=0,g=f.length;k<g;k++){var a={rowData:f[k],focus:!1};h?a.rowIndxPage=k:a.rowIndx=k;c.push(a)}else for(k=0,g=f.length;k<g;k++)c.push({rowIndxPage:k,rowData:f[k],focus:!1});this.add({rows:c})}};n.selectRange=function(c){var f=this.that,h=c.initRowIndx,k=c.initColIndx,g=c.finalRowIndx;c=c.finalColIndx;for(var a=f.colModel,b=a.length,d=this.getSelection().slice(0),l=[],n=0;n<d.length;n++){var s=
d[n],v=s.rowIndx,D=s.dataIndx,s=f.getColIndx({dataIndx:D});v<h||v>g?l.push({rowIndx:v,colIndx:s,dataIndx:D}):v==h&&s<k?l.push({rowIndx:v,colIndx:s,dataIndx:D}):v==g&&s>c&&l.push({rowIndx:v,colIndx:s,dataIndx:D})}this.remove({cells:l});l=[];for(s=0;s<b;s++)if(f=a[s],!f.hidden){D=f.dataIndx;v=h;do{if(!(v==h&&s<k))if(v==g&&s>c)break;else l.push({rowIndx:v,colIndx:s,dataIndx:D,focus:!1});v++}while(v<=g)}this.add({cells:l})};n.selectBlock=function(c){var f=this.that,h=c.initRowIndx,k=c.initColIndx,g=c.finalRowIndx,
a=c.finalColIndx;c=c.evt;for(var b=this.getSelection().slice(0),d=f.colModel,l=[],n=0;n<b.length;n++){var s=b[n],v=s.rowIndx,s=s.dataIndx,D=f.getColIndx({dataIndx:s});D<k||D>a?l.push({rowIndx:v,colIndx:D,dataIndx:s}):(v<h||v>g)&&l.push({rowIndx:v,colIndx:D,dataIndx:s})}this.remove({cells:l});l=[];for(D=k;D<=a;D++)if(f=d[D],s=f.dataIndx,!f.hidden){v=h;do l.push({rowIndx:v,colIndx:D,dataIndx:s,focus:!1}),v++;while(v<=g)}this.add({cells:l,evt:c})}})(jQuery);
...
e=0,f=0,g=0,m=c.length;g<m;g++)c[g][k]?e++:f++;e==m?h=!0:f==m&&(h=!1);this.$inp.pqval({val:h})}};c.onHeaderClick=function(c){var h=this.that,k=g(c.currentTarget).find("input"),e=this.column,f=e.dataIndx,p=h.getColIndx({dataIndx:f}),m=this.cb.all?h.options.dataModel.data:h.pdata,e={column:e,dataIndx:f,source:"header"},r=g(c.target).is("input")?!0:!1,a=k.is(":checked"),b=a;r||(b=!a);if(b){if(!1===h._trigger("beforeCheck",c,e))return!1;r||k.pqval({val:!0});k=0;for(r=m.length;k<r;k++)a=m[k],a[f]=!0;h.$cont.find("td[pq-col-indx="+
p+"] input").prop("checked",!0);!1!==h._trigger("check",c,e)&&this.selectAllRows()}else{if(!1===h._trigger("beforeunCheck",c,e))return!1;r||k.pqval({val:!1});k=0;for(r=m.length;k<r;k++)a=m[k],a[f]=!1;h.$cont.find("td[pq-col-indx="+p+"] input").prop("checked",!1);!1!==h._trigger("unCheck",c,e)&&this.unSelectAllRows()}};c.refreshHeader=function(c,h){if(this.hasHeaderChkBox()){var k=this.that;if(k.pdata){var e=this;if(k=k.getCellHeader({dataIndx:this.dataIndx}))k.html("<input type='checkbox'/>"),this.$inp=
k.find("input"),k.click(function(c){return e.onHeaderClick(c)}),this.setValCBox()}}};c.selectAllRows=function(){this.that.iRows.selectAll({all:this.cb.all})};c.unSelectAllRows=function(){this.that.iRows.removeAll({all:this.cb.all})};c._onDataAvailable=function(){var c=this.that,h=this.options,k=h.dataModel.data,h="remote"==h.pageModel.type?c.rowIndxOffset:0,e=this.column,f=e.dataIndx;if(null!=f&&k){for(var g=[],m=0,r=k.length;m<r;m++){var a=k[m];a[f]&&g.push({rowIndx:m+h,rowData:a})}if(!1!==c._trigger("check",
null,{rows:g,column:e,dataIndx:f,source:"dataAvailable"}))for(m=0;m<r;m++)a=k[m],a[f]&&(a.pq_rowselect=!0)}};c.cellClick=function(c,h){if(h.dataIndx===this.dataIndx)return this.raiseEvent(c,h)};c.rowSelect=function(c,h){var k=this.that,e=h.rows,f=h.rowData,g=this._findSelectionIndx();if(e)for(var m=0,r=e.length;m<r;m++){var f=e[m],a=f.rowIndx,f=f.rowData;f[g]=!0;k.refreshCell({rowIndx:a,dataIndx:g})}else f&&(f[g]=!0,a=h.rowIndx,k.refreshCell({rowIndx:a,dataIndx:g}));this.setValCBox()};c.rowUnSelect=
function(c,h){var k=this.that,e=h.rows,f=h.rowData,g=this._findSelectionIndx();if(e)for(var m=0,r=e.length;m<r;m++){var f=e[m],a=f.rowIndx,f=f.rowData;f[g]=!1;k.refreshCell({rowIndx:a,dataIndx:g})}else f&&(f[g]=!1,a=h.rowIndx,k.refreshCell({rowIndx:a,dataIndx:g}));this.setValCBox()};c.raiseEvent=function(c,h){var k=this.that,e=h.rowData,f=g(c.originalEvent.target).is("input")?!0:!1,p=h.rowIndx,m=h.dataIndx;if(e[m]){if(!1===k._trigger("beforeunCheck",c,h))return!1;e[m]=!1;f||(e=k.getCell(h).find("input"),
...
{x:c.pageX,y:c.pageY});return!0};g._onMousePQUp=function(c,h){this.mousedown=null};g._stopSwipe=function(c){c&&(this.swipedownPrev=this.swipedown=null);window.clearInterval(this.intID);this.intID=null};g._onMouseStop=function(c,h){var k=this,e=this.that;if(this.swipedownPrev){var f=e.options.swipeModel,e=this.swipedownPrev,g=e.ts,m=(new Date).getTime()-g,r=c.pageX,a=c.pageY,b=r-e.x,d=a-e.y;if(Math.sqrt(b*b+d*d)/m>f.ratio){var l=0,q=f.repeat;k._stopSwipe();k.intID=window.setInterval(function(){l+=
f.speed;q--;0>=q&&k._stopSwipe(!0);k._onMouseDrag({pageX:r+l*b/m,pageY:a+l*d/m})},50)}else k.swipedown=null,k.swipedownPrev=null}};g._onMouseDrag=function(c,h){var k=this.that,e=k.options;if(this.swipedown){var f=this.swipedown,g=f.x,m=f.y,r=c.pageX,a=c.pageY;this.swipedownPrev={x:g,y:m,ts:(new Date).getTime()};k.$td_edit&&k.quitEditMode({silent:!0});e.virtualY||(this._scrollVertSmooth(m,a),k._syncScrollBarVert());e.virtualX||(this._scrollHorSmooth(g,r),k._syncScrollBarHor());f.x=r;f.y=a}return!0};
...
h){if(c!=h){var g=this.that,e=h-c,f=g.getTableForHorScroll(),p=g.getTableHeaderForHorScroll(),m=g.$cont,g=g._getSBWidth(),m=m.data("offsetWidth")-g;if(f||p){var r=f?f:p,g=r.data("scrollWidth"),e=parseInt(r.css("marginLeft"))+e;0<e?(f&&f.css({marginLeft:0}),p&&p.css({marginLeft:0})):0<m-g-e?0>=m-g&&(f&&f.css("marginLeft",m-g),p&&p.css("marginLeft",m-g)):(f&&f.css("marginLeft",e),p&&p.css("marginLeft",e))}}}})(jQuery);
...
!0:!1};c.canRedo=function(){return this.counter<this.records.length?!0:!1};c.undo=function(){var c=this.canRedo(),g=this.that,e=this.options.historyModel,f=this.records;if(0<this.counter)this.counter--;else return!1;for(var f=f[this.counter].rowList,p=[],m=0,n=f.length;m<n;m++){var a=f[m],b=a.newRow,d=a.rowData,l=a.type,q=a.oldRow,a=a.rowIndx;"update"==l?(a=g.getRowIndx({rowData:d}).rowIndx,p.push({type:l,rowIndx:a,rowData:d,oldRow:b,newRow:q})):"add"==l?p.push({type:"delete",rowData:b}):"delete"==
l&&p.push({type:"add",rowIndx:a,newRow:d})}g._digestData({history:!1,source:"undo",checkEditable:e.checkEditable,checkEditableAdd:e.checkEditableAdd,allowInvalid:e.allowInvalid,rowList:p});g.refreshView();var s,v;!1===c&&(s=!0);0==this.counter&&(v=!1);g._trigger("history",null,{canUndo:v,canRedo:s,type:"undo",num_undo:this.counter,num_redo:this.records.length-this.counter});return!0};c.redo=function(){var c=this.canUndo(),g=this.that,e=this.options.historyModel,f=this.counter,p=this.records;if(f==
p.length)return!1;for(var f=p[f].rowList,m=[],n=0,a=f.length;n<a;n++){var b=f[n],d=b.newRow,l=b.rowData,q=b.type,s=b.oldRow,b=b.rowIndx;"update"==q?(b=g.getRowIndx({rowData:l}).rowIndx,m.push({type:q,rowIndx:b,rowData:l,oldRow:s,newRow:d})):"add"==q?m.push({type:"add",rowIndx:b,newRow:d}):"delete"==q&&m.push({type:"delete",rowData:l})}g._digestData({history:!1,source:"redo",checkEditable:e.checkEditable,checkEditableAdd:e.checkEditableAdd,allowInvalid:e.allowInvalid,rowList:m});g.refreshView();this.counter<
